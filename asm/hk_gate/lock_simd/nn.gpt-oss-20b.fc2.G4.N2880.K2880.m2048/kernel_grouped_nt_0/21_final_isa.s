...
kernel_grouped_nt_0:
	...
	s_sub_co_ci_u32 s39, s2, 0
	s_sub_co_i32 s40, s1, s3
	s_lshl_b32 s2, s39, 4
	s_abs_i32 s3, s40
	s_sub_co_i32 s12, 36, s2
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	...
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	s_xor_b32 s1, s1, s14
	s_sub_co_i32 s41, s1, s14
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
	s_mul_i32 s42, s41, s12
	s_sub_co_i32 s3, s40, s42
...
.LBB0_8:
	...
	s_cmp_lg_u32 s24, s7
	s_set_vgpr_msb 0xc0
	v_and_b32_e32 v4 /*v772*/, 8, v2
	s_cselect_b32 s7, -1, 0
	s_cmp_lt_i32 s24, 0
	s_cselect_b32 s8, -1, 0
	s_set_vgpr_msb 0xc0b0
	v_and_or_b32 v5 /*v517*/, v0, 7, v4 /*v772*/
	s_and_b32 s7, s8, s7
	...
	v_or_b32_e32 v1 /*v769*/, s9, v3 /*v515*/
	v_or3_b32 v14 /*v782*/, v0, s9, 0x70
	s_cmp_gt_i32 s42, 2
	s_mov_b32 s3, 0x9000
	s_set_vgpr_msb 0xc80c
	v_mul_lo_u32 v1, 0x90, v1 /*v769*/
	s_set_vgpr_msb 0xcc8
	s_delay_alu instid0(VALU_DEP_1)
	v_add_nc_u32_e32 v7 /*v775*/, v1, v4 /*v516*/
	...
	s_set_vgpr_msb 0x8c
	v_or3_b32 v0 /*v512*/, v0, s9, 0x70
	v_add_nc_u32_e32 v1 /*v513*/, 64, v7 /*v775*/
	v_add_nc_u32_e32 v2 /*v514*/, 0x60, v7 /*v775*/
	s_set_vgpr_msb 0x8ce8
	s_delay_alu instid0(VALU_DEP_3)
	v_mad_u32 v8 /*v776*/, 0x90, v0 /*v512*/, v4 /*v516*/
...
.LBB0_11:
	...
	v_mad_u32_u24 v11 /*v779*/, 0x220, v5 /*v517*/, s3
	...
	v_dual_mov_b32 v160, v7 :: v_dual_mov_b32 v255, v7
	...
	v_dual_mov_b32 v240, v7 :: v_dual_mov_b32 v239, v7
	...
	v_dual_mov_b32 v232, v7 :: v_dual_mov_b32 v231, v7
	...
	v_dual_mov_b32 v224, v7 :: v_dual_mov_b32 v223, v7
	...
	v_dual_mov_b32 v216, v7 :: v_dual_mov_b32 v215, v7
	...
	v_dual_mov_b32 v208, v7 :: v_dual_mov_b32 v207, v7
	...
	v_dual_mov_b32 v200, v7 :: v_dual_mov_b32 v199, v7
	...
	v_dual_mov_b32 v192, v7 :: v_dual_mov_b32 v191, v7
	...
	v_dual_mov_b32 v184, v7 :: v_dual_mov_b32 v183, v7
	...
	v_dual_mov_b32 v176, v7 :: v_dual_mov_b32 v175, v7
	v_dual_mov_b32 v174, v7 :: v_dual_mov_b32 v173, v7
	v_dual_mov_b32 v172, v7 :: v_dual_mov_b32 v169, v7
	v_dual_mov_b32 v170, v7 :: v_dual_mov_b32 v171, v7
	...
	v_mul_u32_u24_e32 v3, 0x90, v3 /*v515*/
	s_add_nc_u64 s[26:27], s[22:23], 0x100
	s_and_b32 s22, s29, 0xffff
	s_lshr_b32 s29, s35, 6
	v_mul_u32_u24_e32 v2, 0x220, v5 /*v517*/
	s_set_vgpr_msb 0x8cb
	v_mad_u32 v17 /*v785*/, 0x4800, s29, v3
	v_dual_add_nc_u32 v16 /*v784*/, 0, v4 /*v516*/ :: v_dual_add_nc_u32 v8 /*v776*/, v15 /*v783*/, v4 /*v516*/
	s_max_i32 s3, s33, 0
	...
	v_dual_mov_b32 v167, v0 :: v_dual_mov_b32 v174, v0
	v_dual_mov_b32 v173, v0 :: v_dual_mov_b32 v172, v0
	v_dual_mov_b32 v171, v0 :: v_dual_mov_b32 v170, v0
	v_dual_mov_b32 v169, v0 :: v_dual_mov_b32 v168, v0
	v_dual_mov_b32 v183, v0 :: v_dual_mov_b32 v182, v0
	v_dual_mov_b32 v181, v0 :: v_dual_mov_b32 v180, v0
	v_dual_mov_b32 v179, v0 :: v_dual_mov_b32 v178, v0
	v_dual_mov_b32 v177, v0 :: v_dual_mov_b32 v176, v0
	v_dual_mov_b32 v191, v0 :: v_dual_mov_b32 v190, v0
	v_dual_mov_b32 v189, v0 :: v_dual_mov_b32 v188, v0
	v_dual_mov_b32 v187, v0 :: v_dual_mov_b32 v186, v0
	v_dual_mov_b32 v185, v0 :: v_dual_mov_b32 v184, v0
	v_dual_mov_b32 v199, v0 :: v_dual_mov_b32 v198, v0
	v_dual_mov_b32 v197, v0 :: v_dual_mov_b32 v196, v0
	v_dual_mov_b32 v195, v0 :: v_dual_mov_b32 v194, v0
	v_dual_mov_b32 v193, v0 :: v_dual_mov_b32 v192, v0
	v_dual_mov_b32 v207, v0 :: v_dual_mov_b32 v206, v0
	v_dual_mov_b32 v205, v0 :: v_dual_mov_b32 v204, v0
	v_dual_mov_b32 v203, v0 :: v_dual_mov_b32 v202, v0
	v_dual_mov_b32 v201, v0 :: v_dual_mov_b32 v200, v0
	v_dual_mov_b32 v215, v0 :: v_dual_mov_b32 v214, v0
	v_dual_mov_b32 v213, v0 :: v_dual_mov_b32 v212, v0
	v_dual_mov_b32 v211, v0 :: v_dual_mov_b32 v210, v0
	v_dual_mov_b32 v209, v0 :: v_dual_mov_b32 v208, v0
	v_dual_mov_b32 v223, v0 :: v_dual_mov_b32 v222, v0
	v_dual_mov_b32 v221, v0 :: v_dual_mov_b32 v220, v0
	v_dual_mov_b32 v219, v0 :: v_dual_mov_b32 v218, v0
	v_dual_mov_b32 v217, v0 :: v_dual_mov_b32 v216, v0
	v_dual_mov_b32 v231, v0 :: v_dual_mov_b32 v230, v0
	v_dual_mov_b32 v229, v0 :: v_dual_mov_b32 v228, v0
	v_dual_mov_b32 v227, v0 :: v_dual_mov_b32 v226, v0
	v_dual_mov_b32 v225, v0 :: v_dual_mov_b32 v224, v0
...
.LBB0_13:
	...
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[8:15], v[112:119] /*v[624:631]*/, v[248:255] /*v[760:767]*/, v[8:15]
	v_wmma_f32_16x16x32_bf16 v[16:23], v[152:159] /*v[664:671]*/, v[248:255] /*v[760:767]*/, v[16:23]
	v_wmma_f32_16x16x32_bf16 v[24:31], v[160:167] /*v[672:679]*/, v[248:255] /*v[760:767]*/, v[24:31]
	v_wmma_f32_16x16x32_bf16 v[32:39], v[192:199] /*v[704:711]*/, v[248:255] /*v[760:767]*/, v[32:39]
	v_wmma_f32_16x16x32_bf16 v[40:47], v[208:215] /*v[720:727]*/, v[248:255] /*v[760:767]*/, v[40:47]
	v_wmma_f32_16x16x32_bf16 v[48:55], v[216:223] /*v[728:735]*/, v[248:255] /*v[760:767]*/, v[48:55]
	v_wmma_f32_16x16x32_bf16 v[56:63], v[240:247] /*v[752:759]*/, v[248:255] /*v[760:767]*/, v[56:63]
	v_wmma_f32_16x16x32_bf16 v[120:127], v[240:247] /*v[752:759]*/, v[232:239] /*v[744:751]*/, v[120:127]
	v_wmma_f32_16x16x32_bf16 v[112:119], v[216:223] /*v[728:735]*/, v[232:239] /*v[744:751]*/, v[112:119]
	v_wmma_f32_16x16x32_bf16 v[104:111], v[208:215] /*v[720:727]*/, v[232:239] /*v[744:751]*/, v[104:111]
	v_wmma_f32_16x16x32_bf16 v[96:103], v[192:199] /*v[704:711]*/, v[232:239] /*v[744:751]*/, v[96:103]
	v_wmma_f32_16x16x32_bf16 v[88:95], v[160:167] /*v[672:679]*/, v[232:239] /*v[744:751]*/, v[88:95]
	v_wmma_f32_16x16x32_bf16 v[80:87], v[152:159] /*v[664:671]*/, v[232:239] /*v[744:751]*/, v[80:87]
	v_wmma_f32_16x16x32_bf16 v[72:79], v[112:119] /*v[624:631]*/, v[232:239] /*v[744:751]*/, v[72:79]
	v_wmma_f32_16x16x32_bf16 v[64:71], v[96:103] /*v[608:615]*/, v[232:239] /*v[744:751]*/, v[64:71]
	v_wmma_f32_16x16x32_bf16 v[128:135], v[96:103] /*v[608:615]*/, v[224:231] /*v[736:743]*/, v[128:135]
	v_wmma_f32_16x16x32_bf16 v[136:143], v[112:119] /*v[624:631]*/, v[224:231] /*v[736:743]*/, v[136:143]
	v_wmma_f32_16x16x32_bf16 v[144:151], v[152:159] /*v[664:671]*/, v[224:231] /*v[736:743]*/, v[144:151]
	v_wmma_f32_16x16x32_bf16 v[152:159], v[160:167] /*v[672:679]*/, v[224:231] /*v[736:743]*/, v[152:159]
	v_wmma_f32_16x16x32_bf16 v[160:167], v[192:199] /*v[704:711]*/, v[224:231] /*v[736:743]*/, v[160:167]
	v_wmma_f32_16x16x32_bf16 v[248:255], v[208:215] /*v[720:727]*/, v[224:231] /*v[736:743]*/, v[248:255]
	v_wmma_f32_16x16x32_bf16 v[240:247], v[216:223] /*v[728:735]*/, v[224:231] /*v[736:743]*/, v[240:247]
	v_wmma_f32_16x16x32_bf16 v[232:239], v[240:247] /*v[752:759]*/, v[224:231] /*v[736:743]*/, v[232:239]
	v_wmma_f32_16x16x32_bf16 v[168:175], v[240:247] /*v[752:759]*/, v[200:207] /*v[712:719]*/, v[168:175]
	v_wmma_f32_16x16x32_bf16 v[176:183], v[216:223] /*v[728:735]*/, v[200:207] /*v[712:719]*/, v[176:183]
	v_wmma_f32_16x16x32_bf16 v[184:191], v[208:215] /*v[720:727]*/, v[200:207] /*v[712:719]*/, v[184:191]
	v_wmma_f32_16x16x32_bf16 v[192:199], v[192:199] /*v[704:711]*/, v[200:207] /*v[712:719]*/, v[192:199]
	v_wmma_f32_16x16x32_bf16 v[200:207], v[160:167] /*v[672:679]*/, v[200:207] /*v[712:719]*/, v[200:207]
	v_wmma_f32_16x16x32_bf16 v[208:215], v[152:159] /*v[664:671]*/, v[200:207] /*v[712:719]*/, v[208:215]
	v_wmma_f32_16x16x32_bf16 v[216:223], v[112:119] /*v[624:631]*/, v[200:207] /*v[712:719]*/, v[216:223]
	v_wmma_f32_16x16x32_bf16 v[224:231], v[96:103] /*v[608:615]*/, v[200:207] /*v[712:719]*/, v[224:231]
	s_set_vgpr_msb 0xa5a
	v_wmma_f32_16x16x32_bf16 v[0:7] /*v[256:263]*/, v[96:103] /*v[608:615]*/, v[176:183] /*v[688:695]*/, v[0:7] /*v[256:263]*/
	v_wmma_f32_16x16x32_bf16 v[8:15] /*v[264:271]*/, v[112:119] /*v[624:631]*/, v[176:183] /*v[688:695]*/, v[8:15] /*v[264:271]*/
	v_wmma_f32_16x16x32_bf16 v[16:23] /*v[272:279]*/, v[152:159] /*v[664:671]*/, v[176:183] /*v[688:695]*/, v[16:23] /*v[272:279]*/
	v_wmma_f32_16x16x32_bf16 v[24:31] /*v[280:287]*/, v[160:167] /*v[672:679]*/, v[176:183] /*v[688:695]*/, v[24:31] /*v[280:287]*/
	v_wmma_f32_16x16x32_bf16 v[32:39] /*v[288:295]*/, v[192:199] /*v[704:711]*/, v[176:183] /*v[688:695]*/, v[32:39] /*v[288:295]*/
	v_wmma_f32_16x16x32_bf16 v[40:47] /*v[296:303]*/, v[208:215] /*v[720:727]*/, v[176:183] /*v[688:695]*/, v[40:47] /*v[296:303]*/
	v_wmma_f32_16x16x32_bf16 v[48:55] /*v[304:311]*/, v[216:223] /*v[728:735]*/, v[176:183] /*v[688:695]*/, v[48:55] /*v[304:311]*/
	v_wmma_f32_16x16x32_bf16 v[56:63] /*v[312:319]*/, v[240:247] /*v[752:759]*/, v[176:183] /*v[688:695]*/, v[56:63] /*v[312:319]*/
	v_wmma_f32_16x16x32_bf16 v[120:127] /*v[376:383]*/, v[240:247] /*v[752:759]*/, v[144:151] /*v[656:663]*/, v[120:127] /*v[376:383]*/
	v_wmma_f32_16x16x32_bf16 v[112:119] /*v[368:375]*/, v[216:223] /*v[728:735]*/, v[144:151] /*v[656:663]*/, v[112:119] /*v[368:375]*/
	v_wmma_f32_16x16x32_bf16 v[104:111] /*v[360:367]*/, v[208:215] /*v[720:727]*/, v[144:151] /*v[656:663]*/, v[104:111] /*v[360:367]*/
	v_wmma_f32_16x16x32_bf16 v[96:103] /*v[352:359]*/, v[192:199] /*v[704:711]*/, v[144:151] /*v[656:663]*/, v[96:103] /*v[352:359]*/
	v_wmma_f32_16x16x32_bf16 v[88:95] /*v[344:351]*/, v[160:167] /*v[672:679]*/, v[144:151] /*v[656:663]*/, v[88:95] /*v[344:351]*/
	v_wmma_f32_16x16x32_bf16 v[80:87] /*v[336:343]*/, v[152:159] /*v[664:671]*/, v[144:151] /*v[656:663]*/, v[80:87] /*v[336:343]*/
	v_wmma_f32_16x16x32_bf16 v[72:79] /*v[328:335]*/, v[112:119] /*v[624:631]*/, v[144:151] /*v[656:663]*/, v[72:79] /*v[328:335]*/
	v_wmma_f32_16x16x32_bf16 v[64:71] /*v[320:327]*/, v[96:103] /*v[608:615]*/, v[144:151] /*v[656:663]*/, v[64:71] /*v[320:327]*/
	v_wmma_f32_16x16x32_bf16 v[128:135] /*v[384:391]*/, v[96:103] /*v[608:615]*/, v[104:111] /*v[616:623]*/, v[128:135] /*v[384:391]*/
	v_wmma_f32_16x16x32_bf16 v[136:143] /*v[392:399]*/, v[112:119] /*v[624:631]*/, v[104:111] /*v[616:623]*/, v[136:143] /*v[392:399]*/
	v_wmma_f32_16x16x32_bf16 v[144:151] /*v[400:407]*/, v[152:159] /*v[664:671]*/, v[104:111] /*v[616:623]*/, v[144:151] /*v[400:407]*/
	v_wmma_f32_16x16x32_bf16 v[152:159] /*v[408:415]*/, v[160:167] /*v[672:679]*/, v[104:111] /*v[616:623]*/, v[152:159] /*v[408:415]*/
	v_wmma_f32_16x16x32_bf16 v[160:167] /*v[416:423]*/, v[192:199] /*v[704:711]*/, v[104:111] /*v[616:623]*/, v[160:167] /*v[416:423]*/
	v_wmma_f32_16x16x32_bf16 v[168:175] /*v[424:431]*/, v[208:215] /*v[720:727]*/, v[104:111] /*v[616:623]*/, v[168:175] /*v[424:431]*/
	v_wmma_f32_16x16x32_bf16 v[176:183] /*v[432:439]*/, v[216:223] /*v[728:735]*/, v[104:111] /*v[616:623]*/, v[176:183] /*v[432:439]*/
	v_wmma_f32_16x16x32_bf16 v[192:199] /*v[448:455]*/, v[240:247] /*v[752:759]*/, v[104:111] /*v[616:623]*/, v[192:199] /*v[448:455]*/
	v_wmma_f32_16x16x32_bf16 v[248:255] /*v[504:511]*/, v[240:247] /*v[752:759]*/, v[88:95] /*v[600:607]*/, v[248:255] /*v[504:511]*/
	v_wmma_f32_16x16x32_bf16 v[240:247] /*v[496:503]*/, v[216:223] /*v[728:735]*/, v[88:95] /*v[600:607]*/, v[240:247] /*v[496:503]*/
	v_wmma_f32_16x16x32_bf16 v[232:239] /*v[488:495]*/, v[208:215] /*v[720:727]*/, v[88:95] /*v[600:607]*/, v[232:239] /*v[488:495]*/
	v_wmma_f32_16x16x32_bf16 v[224:231] /*v[480:487]*/, v[192:199] /*v[704:711]*/, v[88:95] /*v[600:607]*/, v[224:231] /*v[480:487]*/
	v_wmma_f32_16x16x32_bf16 v[216:223] /*v[472:479]*/, v[160:167] /*v[672:679]*/, v[88:95] /*v[600:607]*/, v[216:223] /*v[472:479]*/
	v_wmma_f32_16x16x32_bf16 v[208:215] /*v[464:471]*/, v[152:159] /*v[664:671]*/, v[88:95] /*v[600:607]*/, v[208:215] /*v[464:471]*/
	v_wmma_f32_16x16x32_bf16 v[200:207] /*v[456:463]*/, v[112:119] /*v[624:631]*/, v[88:95] /*v[600:607]*/, v[200:207] /*v[456:463]*/
	v_wmma_f32_16x16x32_bf16 v[184:191] /*v[440:447]*/, v[96:103] /*v[608:615]*/, v[88:95] /*v[600:607]*/, v[184:191] /*v[440:447]*/
	s_set_vgpr_msb 0x5a0a
	v_wmma_f32_16x16x32_bf16 v[0:7], v[8:15] /*v[520:527]*/, v[184:191] /*v[696:703]*/, v[0:7]
	v_wmma_f32_16x16x32_bf16 v[8:15], v[24:31] /*v[536:543]*/, v[184:191] /*v[696:703]*/, v[8:15]
	v_wmma_f32_16x16x32_bf16 v[16:23], v[40:47] /*v[552:559]*/, v[184:191] /*v[696:703]*/, v[16:23]
	v_wmma_f32_16x16x32_bf16 v[24:31], v[48:55] /*v[560:567]*/, v[184:191] /*v[696:703]*/, v[24:31]
	v_wmma_f32_16x16x32_bf16 v[32:39], v[64:71] /*v[576:583]*/, v[184:191] /*v[696:703]*/, v[32:39]
	v_wmma_f32_16x16x32_bf16 v[40:47], v[80:87] /*v[592:599]*/, v[184:191] /*v[696:703]*/, v[40:47]
	v_wmma_f32_16x16x32_bf16 v[48:55], v[128:135] /*v[640:647]*/, v[184:191] /*v[696:703]*/, v[48:55]
	v_wmma_f32_16x16x32_bf16 v[56:63], v[136:143] /*v[648:655]*/, v[184:191] /*v[696:703]*/, v[56:63]
	v_wmma_f32_16x16x32_bf16 v[120:127], v[136:143] /*v[648:655]*/, v[168:175] /*v[680:687]*/, v[120:127]
	v_wmma_f32_16x16x32_bf16 v[112:119], v[128:135] /*v[640:647]*/, v[168:175] /*v[680:687]*/, v[112:119]
	v_wmma_f32_16x16x32_bf16 v[104:111], v[80:87] /*v[592:599]*/, v[168:175] /*v[680:687]*/, v[104:111]
	v_wmma_f32_16x16x32_bf16 v[96:103], v[64:71] /*v[576:583]*/, v[168:175] /*v[680:687]*/, v[96:103]
	v_wmma_f32_16x16x32_bf16 v[88:95], v[48:55] /*v[560:567]*/, v[168:175] /*v[680:687]*/, v[88:95]
	v_wmma_f32_16x16x32_bf16 v[80:87], v[40:47] /*v[552:559]*/, v[168:175] /*v[680:687]*/, v[80:87]
	v_wmma_f32_16x16x32_bf16 v[72:79], v[24:31] /*v[536:543]*/, v[168:175] /*v[680:687]*/, v[72:79]
	v_wmma_f32_16x16x32_bf16 v[64:71], v[8:15] /*v[520:527]*/, v[168:175] /*v[680:687]*/, v[64:71]
	v_wmma_f32_16x16x32_bf16 v[128:135], v[8:15] /*v[520:527]*/, v[120:127] /*v[632:639]*/, v[128:135]
	v_wmma_f32_16x16x32_bf16 v[136:143], v[24:31] /*v[536:543]*/, v[120:127] /*v[632:639]*/, v[136:143]
	v_wmma_f32_16x16x32_bf16 v[144:151], v[40:47] /*v[552:559]*/, v[120:127] /*v[632:639]*/, v[144:151]
	v_wmma_f32_16x16x32_bf16 v[152:159], v[48:55] /*v[560:567]*/, v[120:127] /*v[632:639]*/, v[152:159]
	v_wmma_f32_16x16x32_bf16 v[160:167], v[64:71] /*v[576:583]*/, v[120:127] /*v[632:639]*/, v[160:167]
	v_wmma_f32_16x16x32_bf16 v[248:255], v[80:87] /*v[592:599]*/, v[120:127] /*v[632:639]*/, v[248:255]
	v_wmma_f32_16x16x32_bf16 v[240:247], v[128:135] /*v[640:647]*/, v[120:127] /*v[632:639]*/, v[240:247]
	v_wmma_f32_16x16x32_bf16 v[232:239], v[136:143] /*v[648:655]*/, v[120:127] /*v[632:639]*/, v[232:239]
	v_wmma_f32_16x16x32_bf16 v[168:175], v[136:143] /*v[648:655]*/, v[72:79] /*v[584:591]*/, v[168:175]
	v_wmma_f32_16x16x32_bf16 v[176:183], v[128:135] /*v[640:647]*/, v[72:79] /*v[584:591]*/, v[176:183]
	v_wmma_f32_16x16x32_bf16 v[184:191], v[80:87] /*v[592:599]*/, v[72:79] /*v[584:591]*/, v[184:191]
	v_wmma_f32_16x16x32_bf16 v[192:199], v[64:71] /*v[576:583]*/, v[72:79] /*v[584:591]*/, v[192:199]
	v_wmma_f32_16x16x32_bf16 v[200:207], v[48:55] /*v[560:567]*/, v[72:79] /*v[584:591]*/, v[200:207]
	v_wmma_f32_16x16x32_bf16 v[208:215], v[40:47] /*v[552:559]*/, v[72:79] /*v[584:591]*/, v[208:215]
	v_wmma_f32_16x16x32_bf16 v[216:223], v[24:31] /*v[536:543]*/, v[72:79] /*v[584:591]*/, v[216:223]
	v_wmma_f32_16x16x32_bf16 v[224:231], v[8:15] /*v[520:527]*/, v[72:79] /*v[584:591]*/, v[224:231]
	s_set_vgpr_msb 0xa5a
	v_wmma_f32_16x16x32_bf16 v[0:7] /*v[256:263]*/, v[8:15] /*v[520:527]*/, v[56:63] /*v[568:575]*/, v[0:7] /*v[256:263]*/
	v_wmma_f32_16x16x32_bf16 v[8:15] /*v[264:271]*/, v[24:31] /*v[536:543]*/, v[56:63] /*v[568:575]*/, v[8:15] /*v[264:271]*/
	v_wmma_f32_16x16x32_bf16 v[16:23] /*v[272:279]*/, v[40:47] /*v[552:559]*/, v[56:63] /*v[568:575]*/, v[16:23] /*v[272:279]*/
	v_wmma_f32_16x16x32_bf16 v[24:31] /*v[280:287]*/, v[48:55] /*v[560:567]*/, v[56:63] /*v[568:575]*/, v[24:31] /*v[280:287]*/
	v_wmma_f32_16x16x32_bf16 v[32:39] /*v[288:295]*/, v[64:71] /*v[576:583]*/, v[56:63] /*v[568:575]*/, v[32:39] /*v[288:295]*/
	v_wmma_f32_16x16x32_bf16 v[40:47] /*v[296:303]*/, v[80:87] /*v[592:599]*/, v[56:63] /*v[568:575]*/, v[40:47] /*v[296:303]*/
	v_wmma_f32_16x16x32_bf16 v[48:55] /*v[304:311]*/, v[128:135] /*v[640:647]*/, v[56:63] /*v[568:575]*/, v[48:55] /*v[304:311]*/
	v_wmma_f32_16x16x32_bf16 v[56:63] /*v[312:319]*/, v[136:143] /*v[648:655]*/, v[56:63] /*v[568:575]*/, v[56:63] /*v[312:319]*/
	v_wmma_f32_16x16x32_bf16 v[120:127] /*v[376:383]*/, v[136:143] /*v[648:655]*/, v[32:39] /*v[544:551]*/, v[120:127] /*v[376:383]*/
	v_wmma_f32_16x16x32_bf16 v[112:119] /*v[368:375]*/, v[128:135] /*v[640:647]*/, v[32:39] /*v[544:551]*/, v[112:119] /*v[368:375]*/
	v_wmma_f32_16x16x32_bf16 v[104:111] /*v[360:367]*/, v[80:87] /*v[592:599]*/, v[32:39] /*v[544:551]*/, v[104:111] /*v[360:367]*/
	v_wmma_f32_16x16x32_bf16 v[96:103] /*v[352:359]*/, v[64:71] /*v[576:583]*/, v[32:39] /*v[544:551]*/, v[96:103] /*v[352:359]*/
	v_wmma_f32_16x16x32_bf16 v[88:95] /*v[344:351]*/, v[48:55] /*v[560:567]*/, v[32:39] /*v[544:551]*/, v[88:95] /*v[344:351]*/
	v_wmma_f32_16x16x32_bf16 v[80:87] /*v[336:343]*/, v[40:47] /*v[552:559]*/, v[32:39] /*v[544:551]*/, v[80:87] /*v[336:343]*/
	v_wmma_f32_16x16x32_bf16 v[72:79] /*v[328:335]*/, v[24:31] /*v[536:543]*/, v[32:39] /*v[544:551]*/, v[72:79] /*v[328:335]*/
	v_wmma_f32_16x16x32_bf16 v[64:71] /*v[320:327]*/, v[8:15] /*v[520:527]*/, v[32:39] /*v[544:551]*/, v[64:71] /*v[320:327]*/
	v_wmma_f32_16x16x32_bf16 v[128:135] /*v[384:391]*/, v[8:15] /*v[520:527]*/, v[16:23] /*v[528:535]*/, v[128:135] /*v[384:391]*/
	v_wmma_f32_16x16x32_bf16 v[136:143] /*v[392:399]*/, v[24:31] /*v[536:543]*/, v[16:23] /*v[528:535]*/, v[136:143] /*v[392:399]*/
	v_wmma_f32_16x16x32_bf16 v[144:151] /*v[400:407]*/, v[40:47] /*v[552:559]*/, v[16:23] /*v[528:535]*/, v[144:151] /*v[400:407]*/
	v_wmma_f32_16x16x32_bf16 v[152:159] /*v[408:415]*/, v[48:55] /*v[560:567]*/, v[16:23] /*v[528:535]*/, v[152:159] /*v[408:415]*/
	v_wmma_f32_16x16x32_bf16 v[160:167] /*v[416:423]*/, v[64:71] /*v[576:583]*/, v[16:23] /*v[528:535]*/, v[160:167] /*v[416:423]*/
	v_wmma_f32_16x16x32_bf16 v[168:175] /*v[424:431]*/, v[80:87] /*v[592:599]*/, v[16:23] /*v[528:535]*/, v[168:175] /*v[424:431]*/
	v_wmma_f32_16x16x32_bf16 v[176:183] /*v[432:439]*/, v[128:135] /*v[640:647]*/, v[16:23] /*v[528:535]*/, v[176:183] /*v[432:439]*/
	v_wmma_f32_16x16x32_bf16 v[192:199] /*v[448:455]*/, v[136:143] /*v[648:655]*/, v[16:23] /*v[528:535]*/, v[192:199] /*v[448:455]*/
	v_wmma_f32_16x16x32_bf16 v[248:255] /*v[504:511]*/, v[136:143] /*v[648:655]*/, v[0:7] /*v[512:519]*/, v[248:255] /*v[504:511]*/
	v_wmma_f32_16x16x32_bf16 v[240:247] /*v[496:503]*/, v[128:135] /*v[640:647]*/, v[0:7] /*v[512:519]*/, v[240:247] /*v[496:503]*/
	v_wmma_f32_16x16x32_bf16 v[232:239] /*v[488:495]*/, v[80:87] /*v[592:599]*/, v[0:7] /*v[512:519]*/, v[232:239] /*v[488:495]*/
	v_wmma_f32_16x16x32_bf16 v[224:231] /*v[480:487]*/, v[64:71] /*v[576:583]*/, v[0:7] /*v[512:519]*/, v[224:231] /*v[480:487]*/
	v_wmma_f32_16x16x32_bf16 v[216:223] /*v[472:479]*/, v[48:55] /*v[560:567]*/, v[0:7] /*v[512:519]*/, v[216:223] /*v[472:479]*/
	v_wmma_f32_16x16x32_bf16 v[208:215] /*v[464:471]*/, v[40:47] /*v[552:559]*/, v[0:7] /*v[512:519]*/, v[208:215] /*v[464:471]*/
	v_wmma_f32_16x16x32_bf16 v[200:207] /*v[456:463]*/, v[24:31] /*v[536:543]*/, v[0:7] /*v[512:519]*/, v[200:207] /*v[456:463]*/
...
.LBB0_14:
	...
	s_set_vgpr_msb 0x8c
	v_dual_add_nc_u32 v64 /*v576*/, s35, v16 /*v784*/ :: v_dual_add_nc_u32 v129 /*v641*/, s35, v49 /*v817*/
	...
	v_dual_add_nc_u32 v31 /*v543*/, v64 /*v576*/, v31 /*v543*/ :: v_dual_add_nc_u32 v4 /*v516*/, v64 /*v576*/, v4 /*v516*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v8 /*v520*/, s29, v25 /*v793*/
	s_set_vgpr_msb 0x8c8a
	v_dual_add_nc_u32 v5 /*v517*/, v64 /*v576*/, v5 /*v517*/ :: v_dual_add_nc_u32 v58 /*v570*/, v129 /*v641*/, v58 /*v570*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v9 /*v521*/, s29, v26 /*v794*/
	s_set_vgpr_msb 0x8c8a
	v_add_nc_u32_e32 v6 /*v518*/, v64 /*v576*/, v6 /*v518*/
	...
	v_add_nc_u32_e32 v4 /*v516*/, v64 /*v576*/, v7 /*v519*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v12 /*v524*/, s29, v29 /*v797*/
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x8c8a
	v_add_nc_u32_e32 v5 /*v517*/, v64 /*v576*/, v8 /*v520*/
	s_set_vgpr_msb 0x8a8e
	v_subrev_nc_u32_e32 v13 /*v525*/, s29, v30 /*v798*/
	ds_load_b128 v[236:239] /*v[748:751]*/, v6 /*v518*/
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x8e8a
	v_dual_add_nc_u32 v6 /*v518*/, v64 /*v576*/, v9 /*v521*/ :: v_dual_add_nc_u32 v7 /*v519*/, v64 /*v576*/, v10 /*v522*/
	s_set_vgpr_msb 0x8a8e
	...
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x8e8a
	v_add_nc_u32_e32 v4 /*v516*/, v64 /*v576*/, v11 /*v523*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v15 /*v527*/, s29, v32 /*v800*/
	v_subrev_nc_u32_e32 v16 /*v528*/, s29, v33 /*v801*/
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x8c8a
	v_add_nc_u32_e32 v5 /*v517*/, v64 /*v576*/, v12 /*v524*/
	s_set_vgpr_msb 0x8a8e
	...
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x8e8a
	v_add_nc_u32_e32 v6 /*v518*/, v64 /*v576*/, v13 /*v525*/
	s_set_vgpr_msb 0x8a8e
	v_subrev_nc_u32_e32 v0 /*v512*/, s29, v18 /*v786*/
	v_subrev_nc_u32_e32 v57 /*v569*/, s29, v79 /*v847*/
	s_wait_alu depctr_va_vdst(7)
	ds_load_b128 v[176:179] /*v[688:691]*/, v4 /*v516*/
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x8e8a
	v_dual_add_nc_u32 v4 /*v516*/, v64 /*v576*/, v14 /*v526*/ :: v_dual_add_nc_u32 v7 /*v519*/, v64 /*v576*/, v15 /*v527*/
	s_set_vgpr_msb 0x8a8e
	v_subrev_nc_u32_e32 v56 /*v568*/, s29, v78 /*v846*/
	s_wait_alu depctr_va_vdst(6)
	ds_load_b128 v[180:183] /*v[692:695]*/, v5 /*v517*/
	s_wait_alu depctr_va_vdst(4)
	ds_load_b128 v[144:147] /*v[656:659]*/, v6 /*v518*/
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x8e8a
	v_dual_add_nc_u32 v5 /*v517*/, v64 /*v576*/, v16 /*v528*/ :: v_dual_add_nc_u32 v3 /*v515*/, v64 /*v576*/, v3 /*v515*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v55 /*v567*/, s29, v77 /*v845*/
	v_subrev_nc_u32_e32 v54 /*v566*/, s29, v76 /*v844*/
	s_set_vgpr_msb 0x8c8a
	v_add_nc_u32_e32 v0 /*v512*/, v64 /*v576*/, v0 /*v512*/
	s_set_vgpr_msb 0x8a8e
	v_subrev_nc_u32_e32 v53 /*v565*/, s29, v75 /*v843*/
	v_subrev_nc_u32_e32 v47 /*v559*/, s29, v74 /*v842*/
	s_wait_alu depctr_va_vdst(7)
	ds_load_b128 v[148:151] /*v[660:663]*/, v4 /*v516*/
	ds_load_b128 v[104:107] /*v[616:619]*/, v7 /*v519*/
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x8e8a
	v_add_nc_u32_e32 v4 /*v516*/, v129 /*v641*/, v57 /*v569*/
	s_set_vgpr_msb 0x8a8e
	...
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x8e8a
	v_add_nc_u32_e32 v5 /*v517*/, v129 /*v641*/, v56 /*v568*/
	s_set_vgpr_msb 0x8a8e
	...
	s_wait_alu depctr_va_vdst(1)
	ds_load_tr16_b128 v[112:115] /*v[624:627]*/, v5 /*v517*/
	s_wait_alu depctr_vm_vsrc(3)
	s_set_vgpr_msb 0x8e8a
	v_add_nc_u32_e32 v0 /*v512*/, v129 /*v641*/, v55 /*v567*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v38 /*v550*/, s29, v71 /*v839*/
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x8c8a
	v_dual_add_nc_u32 v3 /*v515*/, v129 /*v641*/, v54 /*v566*/ :: v_dual_add_nc_u32 v4 /*v516*/, v129 /*v641*/, v53 /*v565*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v37 /*v549*/, s29, v70 /*v838*/
	v_subrev_nc_u32_e32 v36 /*v548*/, s29, v69 /*v837*/
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x8c8a
	v_dual_add_nc_u32 v5 /*v517*/, v129 /*v641*/, v47 /*v559*/ :: v_dual_add_nc_u32 v6 /*v518*/, v129 /*v641*/, v46 /*v558*/
	s_set_vgpr_msb 0x8a8e
	v_subrev_nc_u32_e32 v35 /*v547*/, s29, v68 /*v836*/
	v_subrev_nc_u32_e32 v34 /*v546*/, s29, v67 /*v835*/
	s_wait_alu depctr_va_vdst(7)
	ds_load_tr16_b128 v[116:119] /*v[628:631]*/, v0 /*v512*/
	s_wait_alu depctr_va_vdst(5)
	ds_load_tr16_b128 v[152:155] /*v[664:667]*/, v3 /*v515*/
	ds_load_tr16_b128 v[156:159] /*v[668:671]*/, v4 /*v516*/
	s_wait_alu depctr_va_vdst(2)
	ds_load_tr16_b128 v[160:163] /*v[672:675]*/, v5 /*v517*/
	ds_load_tr16_b128 v[164:167] /*v[676:679]*/, v6 /*v518*/
	s_wait_alu depctr_vm_vsrc(3)
	s_set_vgpr_msb 0x8e8a
	v_dual_add_nc_u32 v0 /*v512*/, v129 /*v641*/, v39 /*v551*/ :: v_dual_add_nc_u32 v3 /*v515*/, v129 /*v641*/, v38 /*v550*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v33 /*v545*/, s29, v66 /*v834*/
	v_subrev_nc_u32_e32 v32 /*v544*/, s29, v65 /*v833*/
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x8c8a
	v_dual_add_nc_u32 v4 /*v516*/, v129 /*v641*/, v37 /*v549*/ :: v_dual_add_nc_u32 v5 /*v517*/, v129 /*v641*/, v36 /*v548*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v17 /*v529*/, s29, v34 /*v802*/
	v_subrev_nc_u32_e32 v18 /*v530*/, s29, v35 /*v803*/
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x8c8a
	v_add_nc_u32_e32 v6 /*v518*/, v129 /*v641*/, v35 /*v547*/
	s_set_vgpr_msb 0x8a8e
	...
	s_set_vgpr_msb 0x8e8a
	v_add_nc_u32_e32 v0 /*v512*/, v129 /*v641*/, v34 /*v546*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v20 /*v532*/, s29, v37 /*v805*/
	s_wait_alu depctr_vm_vsrc(2)
	s_set_vgpr_msb 0x8c8a
	v_dual_add_nc_u32 v3 /*v515*/, v129 /*v641*/, v33 /*v545*/ :: v_dual_add_nc_u32 v4 /*v516*/, v129 /*v641*/, v32 /*v544*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v21 /*v533*/, s29, v38 /*v806*/
	v_subrev_nc_u32_e32 v22 /*v534*/, s29, v39 /*v807*/
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x8c8a
	v_dual_add_nc_u32 v5 /*v517*/, v64 /*v576*/, v17 /*v529*/ :: v_dual_add_nc_u32 v6 /*v518*/, v64 /*v576*/, v18 /*v530*/
	s_set_vgpr_msb 0x8a8e
	...
	s_wait_alu depctr_va_vdst(2)
	ds_load_b128 v[184:187] /*v[696:699]*/, v5 /*v517*/
	ds_load_b128 v[188:191] /*v[700:703]*/, v6 /*v518*/
	s_wait_alu depctr_vm_vsrc(3)
	s_set_vgpr_msb 0x8e8a
	v_dual_add_nc_u32 v0 /*v512*/, v64 /*v576*/, v19 /*v531*/ :: v_dual_add_nc_u32 v3 /*v515*/, v64 /*v576*/, v20 /*v532*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v25 /*v537*/, s29, v42 /*v810*/
	v_subrev_nc_u32_e32 v26 /*v538*/, s29, v43 /*v811*/
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x8c8a
	v_dual_add_nc_u32 v4 /*v516*/, v64 /*v576*/, v21 /*v533*/ :: v_dual_add_nc_u32 v5 /*v517*/, v64 /*v576*/, v22 /*v534*/
	s_set_vgpr_msb 0x8a8c
	v_subrev_nc_u32_e32 v27 /*v539*/, s29, v44 /*v812*/
	v_subrev_nc_u32_e32 v28 /*v540*/, s29, v45 /*v813*/
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x8c8a
	v_add_nc_u32_e32 v6 /*v518*/, v64 /*v576*/, v23 /*v535*/
	s_set_vgpr_msb 0x8a8e
	v_subrev_nc_u32_e32 v29 /*v541*/, s29, v46 /*v814*/
	v_subrev_nc_u32_e32 v128 /*v640*/, s29, v53 /*v821*/
	...
	ds_load_b128 v[168:171] /*v[680:683]*/, v0 /*v512*/
	ds_load_b128 v[172:175] /*v[684:687]*/, v3 /*v515*/
	s_wait_alu depctr_va_vdst(8)
	ds_load_b128 v[120:123] /*v[632:635]*/, v4 /*v516*/
	ds_load_b128 v[124:127] /*v[636:639]*/, v5 /*v517*/
	s_wait_alu depctr_va_vdst(5)
	ds_load_b128 v[72:75] /*v[584:587]*/, v6 /*v518*/
	s_wait_alu depctr_vm_vsrc(4)
	s_set_vgpr_msb 0x8e8a
	v_add_nc_u32_e32 v0 /*v512*/, v64 /*v576*/, v24 /*v536*/
	s_set_vgpr_msb 0x8a8c
	...
	s_wait_alu depctr_vm_vsrc(2)
	s_set_vgpr_msb 0x8c8a
	v_dual_add_nc_u32 v3 /*v515*/, v64 /*v576*/, v25 /*v537*/ :: v_dual_add_nc_u32 v4 /*v516*/, v64 /*v576*/, v26 /*v538*/
	s_set_vgpr_msb 0x8a8c
	...
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x8c8a
	v_dual_add_nc_u32 v5 /*v517*/, v64 /*v576*/, v27 /*v539*/ :: v_dual_add_nc_u32 v6 /*v518*/, v64 /*v576*/, v28 /*v540*/
	s_set_vgpr_msb 0x8a8e
	...
	s_wait_alu depctr_vm_vsrc(3)
	s_set_vgpr_msb 0x8e8a
	v_dual_add_nc_u32 v0 /*v512*/, v64 /*v576*/, v29 /*v541*/ :: v_dual_add_nc_u32 v3 /*v515*/, v64 /*v576*/, v30 /*v542*/
	v_dual_add_nc_u32 v8 /*v520*/, v129 /*v641*/, v45 /*v557*/ :: v_dual_add_nc_u32 v12 /*v524*/, v129 /*v641*/, v44 /*v556*/
	v_dual_add_nc_u32 v52 /*v564*/, v129 /*v641*/, v52 /*v564*/ :: v_dual_add_nc_u32 v53 /*v565*/, v129 /*v641*/, v51 /*v563*/
	v_dual_add_nc_u32 v128 /*v640*/, v129 /*v641*/, v128 /*v640*/ :: v_dual_add_nc_u32 v132 /*v644*/, v129 /*v641*/, v86 /*v598*/
	v_dual_add_nc_u32 v24 /*v536*/, v129 /*v641*/, v43 /*v555*/ :: v_dual_add_nc_u32 v28 /*v540*/, v129 /*v641*/, v42 /*v554*/
	v_dual_add_nc_u32 v80 /*v592*/, v129 /*v641*/, v48 /*v560*/ :: v_dual_add_nc_u32 v130 /*v642*/, v129 /*v641*/, v87 /*v599*/
	s_wait_alu depctr_vm_vsrc(2)
	v_dual_add_nc_u32 v2 /*v514*/, v64 /*v576*/, v2 /*v514*/ :: v_dual_add_nc_u32 v4 /*v516*/, v64 /*v576*/, v1 /*v513*/
	v_dual_add_nc_u32 v64 /*v576*/, v129 /*v641*/, v50 /*v562*/ :: v_dual_add_nc_u32 v68 /*v580*/, v129 /*v641*/, v49 /*v561*/
	v_dual_add_nc_u32 v41 /*v553*/, v129 /*v641*/, v41 /*v553*/ :: v_dual_add_nc_u32 v44 /*v556*/, v129 /*v641*/, v40 /*v552*/
	v_dual_add_nc_u32 v136 /*v648*/, v129 /*v641*/, v85 /*v597*/ :: v_dual_add_nc_u32 v140 /*v652*/, v129 /*v641*/, v84 /*v596*/
	...
	ds_load_tr16_b128 v[84:87] /*v[596:599]*/, v128 /*v640*/
	s_wait_alu depctr_vm_vsrc(0)
	ds_load_tr16_b128 v[128:131] /*v[640:643]*/, v130 /*v642*/
	ds_load_tr16_b128 v[132:135] /*v[644:647]*/, v132 /*v644*/
	s_wait_alu depctr_va_vdst(0)
	ds_load_tr16_b128 v[136:139] /*v[648:651]*/, v136 /*v648*/
	ds_load_tr16_b128 v[140:143] /*v[652:655]*/, v140 /*v652*/
...
.LBB0_18:
	...
	v_nop
	s_set_vgpr_msb 0x83
	v_dual_mov_b32 v0 /*v512*/, v14 /*v782*/ :: v_dual_mov_b32 v1 /*v513*/, v13 /*v781*/
	v_mov_b32_e32 v2 /*v514*/, v12 /*v780*/
	s_set_vgpr_msb 0x8300
.LBB0_19:
	s_set_vgpr_msb 0x8c
	v_or3_b32 v3 /*v515*/, s24, v10 /*v778*/, s2
	...
	v_subrev_nc_u32_e32 v3 /*v515*/, s6, v3 /*v515*/
	s_mul_i32 s0, s0, 3
	s_barrier_signal -1
	s_sub_co_i32 s0, s7, s0
	s_barrier_wait -1
	v_lshl_add_u32 v3 /*v515*/, v3 /*v515*/, 1, v11 /*v779*/
	s_mul_i32 s0, s0, 0x11800
	s_delay_alu instid0(SALU_CYCLE_1)
	s_add_co_i32 s0, s0, 0
	s_ashr_i32 s35, s34, 31
	s_set_vgpr_msb 0xba8c
	v_add_nc_u32_e32 v184 /*v696*/, s0, v7 /*v775*/
	s_set_vgpr_msb 0x8c88
	v_add_nc_u32_e32 v252 /*v764*/, s0, v3 /*v515*/
	s_set_vgpr_msb 0x888c
	v_dual_add_nc_u32 v60 /*v572*/, s0, v8 /*v776*/ :: v_dual_add_nc_u32 v64 /*v576*/, s0, v9 /*v777*/
	s_wait_alu depctr_vm_vsrc(2)
	s_set_vgpr_msb 0x8c8a
	v_add_nc_u32_e32 v132 /*v644*/, s0, v1 /*v513*/
	s_wait_alu depctr_va_vdst(0)
	ds_load_b128 v[4:7] /*v[516:519]*/, v184 /*v696*/
	ds_load_b128 v[8:11] /*v[520:523]*/, v184 /*v696*/ offset:32
	ds_load_b128 v[12:15] /*v[524:527]*/, v184 /*v696*/ offset:2304
	ds_load_b128 v[16:19] /*v[528:531]*/, v184 /*v696*/ offset:2336
	ds_load_b128 v[20:23] /*v[532:535]*/, v184 /*v696*/ offset:4608
	ds_load_b128 v[24:27] /*v[536:539]*/, v184 /*v696*/ offset:4640
	ds_load_b128 v[28:31] /*v[540:543]*/, v184 /*v696*/ offset:6912
	ds_load_b128 v[32:35] /*v[544:547]*/, v184 /*v696*/ offset:6944
	ds_load_b128 v[36:39] /*v[548:551]*/, v184 /*v696*/ offset:9216
	ds_load_b128 v[40:43] /*v[552:555]*/, v184 /*v696*/ offset:9248
	ds_load_b128 v[44:47] /*v[556:559]*/, v184 /*v696*/ offset:11520
	ds_load_b128 v[48:51] /*v[560:563]*/, v184 /*v696*/ offset:11552
	ds_load_b128 v[52:55] /*v[564:567]*/, v184 /*v696*/ offset:13824
	ds_load_b128 v[56:59] /*v[568:571]*/, v184 /*v696*/ offset:13856
	ds_load_b128 v[60:63] /*v[572:575]*/, v60 /*v572*/
	ds_load_b128 v[64:67] /*v[576:579]*/, v64 /*v576*/
	ds_load_tr16_b128 v[72:75] /*v[584:587]*/, v252 /*v764*/ offset:8704
	ds_load_tr16_b128 v[68:71] /*v[580:583]*/, v252 /*v764*/
	ds_load_tr16_b128 v[76:79] /*v[588:591]*/, v252 /*v764*/ offset:32
	ds_load_tr16_b128 v[80:83] /*v[592:595]*/, v252 /*v764*/ offset:8736
	ds_load_tr16_b128 v[84:87] /*v[596:599]*/, v252 /*v764*/ offset:64
	ds_load_tr16_b128 v[88:91] /*v[600:603]*/, v252 /*v764*/ offset:8768
	ds_load_tr16_b128 v[92:95] /*v[604:607]*/, v252 /*v764*/ offset:96
	ds_load_tr16_b128 v[96:99] /*v[608:611]*/, v252 /*v764*/ offset:8800
	ds_load_tr16_b128 v[100:103] /*v[612:615]*/, v252 /*v764*/ offset:128
	ds_load_tr16_b128 v[104:107] /*v[616:619]*/, v252 /*v764*/ offset:8832
	ds_load_tr16_b128 v[108:111] /*v[620:623]*/, v252 /*v764*/ offset:160
	ds_load_tr16_b128 v[112:115] /*v[624:627]*/, v252 /*v764*/ offset:8864
	ds_load_tr16_b128 v[116:119] /*v[628:631]*/, v252 /*v764*/ offset:192
	ds_load_tr16_b128 v[120:123] /*v[632:635]*/, v252 /*v764*/ offset:8896
	ds_load_tr16_b128 v[124:127] /*v[636:639]*/, v252 /*v764*/ offset:224
	ds_load_tr16_b128 v[128:131] /*v[640:643]*/, v252 /*v764*/ offset:8928
	s_wait_alu depctr_vm_vsrc(6)
	v_add_nc_u32_e32 v136 /*v648*/, s0, v2 /*v514*/
	s_set_vgpr_msb 0x8a8e
	v_dual_add_nc_u32 v188 /*v700*/, s0, v5 /*v773*/ :: v_dual_add_nc_u32 v192 /*v704*/, s0, v6 /*v774*/
	ds_load_b128 v[132:135] /*v[644:647]*/, v132 /*v644*/
	ds_load_b128 v[140:143] /*v[652:655]*/, v184 /*v696*/ offset:2368
	s_wait_alu depctr_va_vdst(1)
	ds_load_b128 v[136:139] /*v[648:651]*/, v136 /*v648*/
	ds_load_b128 v[144:147] /*v[656:659]*/, v184 /*v696*/ offset:2400
	ds_load_b128 v[148:151] /*v[660:663]*/, v184 /*v696*/ offset:4672
	ds_load_b128 v[152:155] /*v[664:667]*/, v184 /*v696*/ offset:4704
	ds_load_b128 v[156:159] /*v[668:671]*/, v184 /*v696*/ offset:6976
	ds_load_b128 v[160:163] /*v[672:675]*/, v184 /*v696*/ offset:7008
	ds_load_b128 v[164:167] /*v[676:679]*/, v184 /*v696*/ offset:9280
	ds_load_b128 v[168:171] /*v[680:683]*/, v184 /*v696*/ offset:9312
	ds_load_b128 v[172:175] /*v[684:687]*/, v184 /*v696*/ offset:11584
	ds_load_b128 v[176:179] /*v[688:691]*/, v184 /*v696*/ offset:11616
	ds_load_b128 v[180:183] /*v[692:695]*/, v184 /*v696*/ offset:13888
	s_wait_alu depctr_vm_vsrc(0)
	ds_load_b128 v[184:187] /*v[696:699]*/, v184 /*v696*/ offset:13920
	s_wait_alu depctr_va_vdst(0)
	ds_load_b128 v[188:191] /*v[700:703]*/, v188 /*v700*/
	ds_load_b128 v[192:195] /*v[704:707]*/, v192 /*v704*/
	ds_load_tr16_b128 v[196:199] /*v[708:711]*/, v252 /*v764*/ offset:17408
	ds_load_tr16_b128 v[200:203] /*v[712:715]*/, v252 /*v764*/ offset:26112
	ds_load_tr16_b128 v[204:207] /*v[716:719]*/, v252 /*v764*/ offset:17440
	ds_load_tr16_b128 v[208:211] /*v[720:723]*/, v252 /*v764*/ offset:26144
	ds_load_tr16_b128 v[212:215] /*v[724:727]*/, v252 /*v764*/ offset:17472
	ds_load_tr16_b128 v[216:219] /*v[728:731]*/, v252 /*v764*/ offset:26176
	ds_load_tr16_b128 v[220:223] /*v[732:735]*/, v252 /*v764*/ offset:17504
	ds_load_tr16_b128 v[224:227] /*v[736:739]*/, v252 /*v764*/ offset:26208
	ds_load_tr16_b128 v[228:231] /*v[740:743]*/, v252 /*v764*/ offset:17536
	ds_load_tr16_b128 v[232:235] /*v[744:747]*/, v252 /*v764*/ offset:26240
	ds_load_tr16_b128 v[236:239] /*v[748:751]*/, v252 /*v764*/ offset:17568
	ds_load_tr16_b128 v[240:243] /*v[752:755]*/, v252 /*v764*/ offset:26272
	ds_load_tr16_b128 v[244:247] /*v[756:759]*/, v252 /*v764*/ offset:17600
	ds_load_tr16_b128 v[248:251] /*v[760:763]*/, v252 /*v764*/ offset:26304
	s_set_vgpr_msb 0x8ec2
	ds_load_tr16_b128 v[10:13] /*v[778:781]*/, v252 /*v764*/ offset:17632
	ds_load_tr16_b128 v[14:17] /*v[782:785]*/, v252 /*v764*/ offset:26336
	...
	v_wmma_f32_16x16x32_bf16 v[248:255], v[108:115] /*v[620:627]*/, v[20:27] /*v[532:539]*/, v[248:255]
	v_wmma_f32_16x16x32_bf16 v[240:247], v[116:123] /*v[628:635]*/, v[20:27] /*v[532:539]*/, v[240:247]
	v_wmma_f32_16x16x32_bf16 v[232:239], v[124:131] /*v[636:643]*/, v[20:27] /*v[532:539]*/, v[232:239]
	v_wmma_f32_16x16x32_bf16 v[168:175], v[124:131] /*v[636:643]*/, v[28:35] /*v[540:547]*/, v[168:175]
	v_wmma_f32_16x16x32_bf16 v[176:183], v[116:123] /*v[628:635]*/, v[28:35] /*v[540:547]*/, v[176:183]
	v_wmma_f32_16x16x32_bf16 v[184:191], v[108:115] /*v[620:627]*/, v[28:35] /*v[540:547]*/, v[184:191]
	v_wmma_f32_16x16x32_bf16 v[192:199], v[100:107] /*v[612:619]*/, v[28:35] /*v[540:547]*/, v[192:199]
	v_wmma_f32_16x16x32_bf16 v[200:207], v[92:99] /*v[604:611]*/, v[28:35] /*v[540:547]*/, v[200:207]
	v_wmma_f32_16x16x32_bf16 v[208:215], v[84:91] /*v[596:603]*/, v[28:35] /*v[540:547]*/, v[208:215]
	v_wmma_f32_16x16x32_bf16 v[216:223], v[76:83] /*v[588:595]*/, v[28:35] /*v[540:547]*/, v[216:223]
	v_wmma_f32_16x16x32_bf16 v[224:231], v[68:75] /*v[580:587]*/, v[28:35] /*v[540:547]*/, v[224:231]
	s_set_vgpr_msb 0xa5a
	...
	v_wmma_f32_16x16x32_bf16 v[56:63], v[10:17] /*v[778:785]*/, v[132:139] /*v[644:651]*/, v[56:63]
	v_wmma_f32_16x16x32_bf16 v[120:127], v[10:17] /*v[778:785]*/, v[140:147] /*v[652:659]*/, v[120:127]
	...
	v_wmma_f32_16x16x32_bf16 v[248:255], v[236:243] /*v[748:755]*/, v[148:155] /*v[660:667]*/, v[248:255]
	v_wmma_f32_16x16x32_bf16 v[240:247], v[244:251] /*v[756:763]*/, v[148:155] /*v[660:667]*/, v[240:247]
	s_set_vgpr_msb 0xa0b
	v_wmma_f32_16x16x32_bf16 v[232:239], v[10:17] /*v[778:785]*/, v[148:155] /*v[660:667]*/, v[232:239]
	v_wmma_f32_16x16x32_bf16 v[168:175], v[10:17] /*v[778:785]*/, v[156:163] /*v[668:675]*/, v[168:175]
	s_set_vgpr_msb 0xb0a
	v_wmma_f32_16x16x32_bf16 v[176:183], v[244:251] /*v[756:763]*/, v[156:163] /*v[668:675]*/, v[176:183]
	v_wmma_f32_16x16x32_bf16 v[184:191], v[236:243] /*v[748:755]*/, v[156:163] /*v[668:675]*/, v[184:191]
	v_wmma_f32_16x16x32_bf16 v[192:199], v[228:235] /*v[740:747]*/, v[156:163] /*v[668:675]*/, v[192:199]
	v_wmma_f32_16x16x32_bf16 v[200:207], v[220:227] /*v[732:739]*/, v[156:163] /*v[668:675]*/, v[200:207]
	v_wmma_f32_16x16x32_bf16 v[208:215], v[212:219] /*v[724:731]*/, v[156:163] /*v[668:675]*/, v[208:215]
	v_wmma_f32_16x16x32_bf16 v[216:223], v[204:211] /*v[716:723]*/, v[156:163] /*v[668:675]*/, v[216:223]
	v_wmma_f32_16x16x32_bf16 v[224:231], v[196:203] /*v[708:715]*/, v[156:163] /*v[668:675]*/, v[224:231]
	s_set_vgpr_msb 0xa5a
	...
	v_wmma_f32_16x16x32_bf16 v[56:63] /*v[312:319]*/, v[10:17] /*v[778:785]*/, v[164:171] /*v[676:683]*/, v[56:63] /*v[312:319]*/
	v_wmma_f32_16x16x32_bf16 v[120:127] /*v[376:383]*/, v[10:17] /*v[778:785]*/, v[172:179] /*v[684:691]*/, v[120:127] /*v[376:383]*/
	...
	s_set_vgpr_msb 0x5a5b
	v_wmma_f32_16x16x32_bf16 v[192:199] /*v[448:455]*/, v[10:17] /*v[778:785]*/, v[180:187] /*v[692:699]*/, v[192:199] /*v[448:455]*/
	v_wmma_f32_16x16x32_bf16 v[248:255] /*v[504:511]*/, v[10:17] /*v[778:785]*/, v[188:195] /*v[700:707]*/, v[248:255] /*v[504:511]*/
	s_set_vgpr_msb 0x5b5a
	...
	v_add_nc_u32_e32 v184 /*v696*/, s1, v7 /*v775*/
	s_set_vgpr_msb 0x8c88
	v_add_nc_u32_e32 v3 /*v515*/, s1, v3 /*v515*/
	s_set_vgpr_msb 0x888c
	v_dual_add_nc_u32 v60 /*v572*/, s1, v8 /*v776*/ :: v_dual_add_nc_u32 v64 /*v576*/, s1, v9 /*v777*/
	s_set_vgpr_msb 0x8c8a
	v_dual_add_nc_u32 v1 /*v513*/, s1, v1 /*v513*/ :: v_dual_add_nc_u32 v2 /*v514*/, s1, v2 /*v514*/
	s_wait_alu depctr_va_vdst(0)
	ds_load_b128 v[4:7] /*v[516:519]*/, v184 /*v696*/
	ds_load_b128 v[8:11] /*v[520:523]*/, v184 /*v696*/ offset:32
	ds_load_b128 v[12:15] /*v[524:527]*/, v184 /*v696*/ offset:2304
	...
	ds_load_b128 v[60:63] /*v[572:575]*/, v60 /*v572*/
	ds_load_b128 v[64:67] /*v[576:579]*/, v64 /*v576*/
	ds_load_tr16_b128 v[72:75] /*v[584:587]*/, v3 /*v515*/ offset:8704
	ds_load_tr16_b128 v[68:71] /*v[580:583]*/, v3 /*v515*/
	ds_load_tr16_b128 v[76:79] /*v[588:591]*/, v3 /*v515*/ offset:32
	ds_load_tr16_b128 v[80:83] /*v[592:595]*/, v3 /*v515*/ offset:8736
	ds_load_tr16_b128 v[84:87] /*v[596:599]*/, v3 /*v515*/ offset:64
	ds_load_tr16_b128 v[88:91] /*v[600:603]*/, v3 /*v515*/ offset:8768
	ds_load_tr16_b128 v[92:95] /*v[604:607]*/, v3 /*v515*/ offset:96
	ds_load_tr16_b128 v[96:99] /*v[608:611]*/, v3 /*v515*/ offset:8800
	ds_load_tr16_b128 v[100:103] /*v[612:615]*/, v3 /*v515*/ offset:128
	ds_load_tr16_b128 v[104:107] /*v[616:619]*/, v3 /*v515*/ offset:8832
	ds_load_tr16_b128 v[108:111] /*v[620:623]*/, v3 /*v515*/ offset:160
	ds_load_tr16_b128 v[112:115] /*v[624:627]*/, v3 /*v515*/ offset:8864
	ds_load_tr16_b128 v[116:119] /*v[628:631]*/, v3 /*v515*/ offset:192
	ds_load_tr16_b128 v[120:123] /*v[632:635]*/, v3 /*v515*/ offset:8896
	ds_load_tr16_b128 v[124:127] /*v[636:639]*/, v3 /*v515*/ offset:224
	ds_load_tr16_b128 v[128:131] /*v[640:643]*/, v3 /*v515*/ offset:8928
	ds_load_b128 v[132:135] /*v[644:647]*/, v1 /*v513*/
	ds_load_b128 v[136:139] /*v[648:651]*/, v2 /*v514*/
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x8a8e
	v_dual_add_nc_u32 v1 /*v513*/, s1, v5 /*v773*/ :: v_dual_add_nc_u32 v2 /*v514*/, s1, v6 /*v774*/
	ds_load_b128 v[140:143] /*v[652:655]*/, v184 /*v696*/ offset:2368
	ds_load_b128 v[144:147] /*v[656:659]*/, v184 /*v696*/ offset:2400
	ds_load_b128 v[148:151] /*v[660:663]*/, v184 /*v696*/ offset:4672
	ds_load_b128 v[152:155] /*v[664:667]*/, v184 /*v696*/ offset:4704
	...
	ds_load_b128 v[184:187] /*v[696:699]*/, v184 /*v696*/ offset:13920
	s_wait_alu depctr_va_vdst(0)
	ds_load_b128 v[188:191] /*v[700:703]*/, v1 /*v513*/
	ds_load_b128 v[192:195] /*v[704:707]*/, v2 /*v514*/
	ds_load_tr16_b128 v[196:199] /*v[708:711]*/, v3 /*v515*/ offset:17408
	ds_load_tr16_b128 v[200:203] /*v[712:715]*/, v3 /*v515*/ offset:26112
	ds_load_tr16_b128 v[204:207] /*v[716:719]*/, v3 /*v515*/ offset:17440
	ds_load_tr16_b128 v[208:211] /*v[720:723]*/, v3 /*v515*/ offset:26144
	ds_load_tr16_b128 v[212:215] /*v[724:727]*/, v3 /*v515*/ offset:17472
	ds_load_tr16_b128 v[216:219] /*v[728:731]*/, v3 /*v515*/ offset:26176
	ds_load_tr16_b128 v[220:223] /*v[732:735]*/, v3 /*v515*/ offset:17504
	ds_load_tr16_b128 v[224:227] /*v[736:739]*/, v3 /*v515*/ offset:26208
	ds_load_tr16_b128 v[228:231] /*v[740:743]*/, v3 /*v515*/ offset:17536
	ds_load_tr16_b128 v[232:235] /*v[744:747]*/, v3 /*v515*/ offset:26240
	ds_load_tr16_b128 v[236:239] /*v[748:751]*/, v3 /*v515*/ offset:17568
	ds_load_tr16_b128 v[240:243] /*v[752:755]*/, v3 /*v515*/ offset:26272
	ds_load_tr16_b128 v[244:247] /*v[756:759]*/, v3 /*v515*/ offset:17600
	ds_load_tr16_b128 v[248:251] /*v[760:763]*/, v3 /*v515*/ offset:26304
	s_set_vgpr_msb 0x8ec2
	ds_load_tr16_b128 v[6:9] /*v[774:777]*/, v3 /*v515*/ offset:17632
	ds_load_tr16_b128 v[10:13] /*v[778:781]*/, v3 /*v515*/ offset:26336
	s_set_vgpr_msb 0xc20a
	s_wait_dscnt 0x2e
	v_wmma_f32_16x16x32_bf16 v[0:7], v[68:75] /*v[580:587]*/, v[4:11] /*v[516:523]*/, v[0:7]
	s_wait_dscnt 0x0
	...
	v_wmma_f32_16x16x32_bf16 v[48:55], v[244:251] /*v[756:763]*/, v[132:139] /*v[644:651]*/, v[48:55]
	s_set_vgpr_msb 0xa0b
	v_wmma_f32_16x16x32_bf16 v[56:63], v[6:13] /*v[774:781]*/, v[132:139] /*v[644:651]*/, v[56:63]
	v_wmma_f32_16x16x32_bf16 v[120:127], v[6:13] /*v[774:781]*/, v[140:147] /*v[652:659]*/, v[120:127]
	s_set_vgpr_msb 0xb0a
	v_wmma_f32_16x16x32_bf16 v[112:119], v[244:251] /*v[756:763]*/, v[140:147] /*v[652:659]*/, v[112:119]
	v_wmma_f32_16x16x32_bf16 v[104:111], v[236:243] /*v[748:755]*/, v[140:147] /*v[652:659]*/, v[104:111]
	v_wmma_f32_16x16x32_bf16 v[96:103], v[228:235] /*v[740:747]*/, v[140:147] /*v[652:659]*/, v[96:103]
	...
	v_wmma_f32_16x16x32_bf16 v[240:247], v[244:251] /*v[756:763]*/, v[148:155] /*v[660:667]*/, v[240:247]
	s_set_vgpr_msb 0xa0b
	v_wmma_f32_16x16x32_bf16 v[232:239], v[6:13] /*v[774:781]*/, v[148:155] /*v[660:667]*/, v[232:239]
	v_wmma_f32_16x16x32_bf16 v[168:175], v[6:13] /*v[774:781]*/, v[156:163] /*v[668:675]*/, v[168:175]
	s_set_vgpr_msb 0xb0a
	v_wmma_f32_16x16x32_bf16 v[176:183], v[244:251] /*v[756:763]*/, v[156:163] /*v[668:675]*/, v[176:183]
	v_wmma_f32_16x16x32_bf16 v[184:191], v[236:243] /*v[748:755]*/, v[156:163] /*v[668:675]*/, v[184:191]
	v_wmma_f32_16x16x32_bf16 v[192:199], v[228:235] /*v[740:747]*/, v[156:163] /*v[668:675]*/, v[192:199]
	...
	v_wmma_f32_16x16x32_bf16 v[48:55] /*v[304:311]*/, v[244:251] /*v[756:763]*/, v[164:171] /*v[676:683]*/, v[48:55] /*v[304:311]*/
	s_set_vgpr_msb 0x5a5b
	v_wmma_f32_16x16x32_bf16 v[56:63] /*v[312:319]*/, v[6:13] /*v[774:781]*/, v[164:171] /*v[676:683]*/, v[56:63] /*v[312:319]*/
	v_wmma_f32_16x16x32_bf16 v[120:127] /*v[376:383]*/, v[6:13] /*v[774:781]*/, v[172:179] /*v[684:691]*/, v[120:127] /*v[376:383]*/
	s_set_vgpr_msb 0x5b5a
	v_wmma_f32_16x16x32_bf16 v[112:119] /*v[368:375]*/, v[244:251] /*v[756:763]*/, v[172:179] /*v[684:691]*/, v[112:119] /*v[368:375]*/
	v_wmma_f32_16x16x32_bf16 v[104:111] /*v[360:367]*/, v[236:243] /*v[748:755]*/, v[172:179] /*v[684:691]*/, v[104:111] /*v[360:367]*/
	v_wmma_f32_16x16x32_bf16 v[96:103] /*v[352:359]*/, v[228:235] /*v[740:747]*/, v[172:179] /*v[684:691]*/, v[96:103] /*v[352:359]*/
	...
	v_wmma_f32_16x16x32_bf16 v[176:183] /*v[432:439]*/, v[244:251] /*v[756:763]*/, v[180:187] /*v[692:699]*/, v[176:183] /*v[432:439]*/
	s_set_vgpr_msb 0x5a5b
	v_wmma_f32_16x16x32_bf16 v[192:199] /*v[448:455]*/, v[6:13] /*v[774:781]*/, v[180:187] /*v[692:699]*/, v[192:199] /*v[448:455]*/
	v_wmma_f32_16x16x32_bf16 v[248:255] /*v[504:511]*/, v[6:13] /*v[774:781]*/, v[188:195] /*v[700:707]*/, v[248:255] /*v[504:511]*/
	s_set_vgpr_msb 0x5b5a
	v_wmma_f32_16x16x32_bf16 v[240:247] /*v[496:503]*/, v[244:251] /*v[756:763]*/, v[188:195] /*v[700:707]*/, v[240:247] /*v[496:503]*/
	v_wmma_f32_16x16x32_bf16 v[232:239] /*v[488:495]*/, v[236:243] /*v[748:755]*/, v[188:195] /*v[700:707]*/, v[232:239] /*v[488:495]*/
	v_wmma_f32_16x16x32_bf16 v[224:231] /*v[480:487]*/, v[228:235] /*v[740:747]*/, v[188:195] /*v[700:707]*/, v[224:231] /*v[480:487]*/
	...
	s_wait_alu depctr_vm_vsrc(6)
	s_set_vgpr_msb 0x5a8c
	v_or_b32_e32 v1 /*v513*/, s24, v4 /*v772*/
	...
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x200
	v_cvt_pk_bf16_f32 v23, v254, v255
	v_cvt_pk_bf16_f32 v22, v252, v253
	v_cvt_pk_bf16_f32 v21, v250, v251
	v_cvt_pk_bf16_f32 v20, v248, v249
	s_set_vgpr_msb 2
	...
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x200
	v_cvt_pk_bf16_f32 v23, v206, v207
	v_cvt_pk_bf16_f32 v22, v204, v205
	...
	s_wait_alu depctr_vm_vsrc(2)
	v_cvt_pk_bf16_f32 v11, v230, v231
	v_cvt_pk_bf16_f32 v10, v228, v229
	v_cvt_pk_bf16_f32 v9, v226, v227
	v_cvt_pk_bf16_f32 v8, v224, v225
	s_wait_alu depctr_vm_vsrc(1)
	v_cvt_pk_bf16_f32 v15, v222, v223
	v_cvt_pk_bf16_f32 v14, v220, v221
	v_cvt_pk_bf16_f32 v13, v218, v219
	v_cvt_pk_bf16_f32 v12, v216, v217
	s_wait_alu depctr_vm_vsrc(0)
	...
	s_wait_alu depctr_vm_vsrc(4)
	s_set_vgpr_msb 0x200
	v_cvt_pk_bf16_f32 v3, v198, v199
	v_cvt_pk_bf16_f32 v2, v196, v197
	v_cvt_pk_bf16_f32 v1, v194, v195
	v_cvt_pk_bf16_f32 v0, v192, v193
	s_wait_alu depctr_vm_vsrc(3)
