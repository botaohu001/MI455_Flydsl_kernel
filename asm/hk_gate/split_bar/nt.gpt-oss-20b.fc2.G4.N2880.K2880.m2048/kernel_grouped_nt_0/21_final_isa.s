...
.LBB0_13:
	s_set_vgpr_msb 4
	s_wait_dscnt 0xf
	v_wmma_f32_16x16x32_bf16 v[8:15], v[200:207], v[40:47] /*v[296:303]*/, v[8:15]
	s_wait_dscnt 0x0
	...
	v_wmma_f32_16x16x32_bf16 v[72:79], v[200:207], v[248:255], v[72:79]
	v_wmma_f32_16x16x32_bf16 v[128:135], v[200:207], v[232:239], v[128:135]
	s_set_vgpr_msb 1
	v_wmma_f32_16x16x32_bf16 v[144:151], v[8:15] /*v[264:271]*/, v[232:239], v[144:151]
	v_wmma_f32_16x16x32_bf16 v[152:159], v[24:31] /*v[280:287]*/, v[232:239], v[152:159]
	v_wmma_f32_16x16x32_bf16 v[168:175], v[56:63] /*v[312:319]*/, v[232:239], v[168:175]
	v_wmma_f32_16x16x32_bf16 v[176:183], v[72:79] /*v[328:335]*/, v[232:239], v[176:183]
	v_wmma_f32_16x16x32_bf16 v[184:191], v[88:95] /*v[344:351]*/, v[232:239], v[184:191]
	v_wmma_f32_16x16x32_bf16 v[56:63], v[88:95] /*v[344:351]*/, v[192:199], v[56:63]
	v_wmma_f32_16x16x32_bf16 v[40:47], v[72:79] /*v[328:335]*/, v[192:199], v[40:47]
	v_wmma_f32_16x16x32_bf16 v[32:39], v[56:63] /*v[312:319]*/, v[192:199], v[32:39]
	v_wmma_f32_16x16x32_bf16 v[24:31], v[24:31] /*v[280:287]*/, v[192:199], v[24:31]
	v_wmma_f32_16x16x32_bf16 v[16:23], v[8:15] /*v[264:271]*/, v[192:199], v[16:23]
	s_set_vgpr_msb 0x100
	...
	v_wmma_f32_16x16x32_bf16 v[128:135], v[224:231], v[216:223], v[128:135]
	s_set_vgpr_msb 1
	v_wmma_f32_16x16x32_bf16 v[144:151], v[0:7] /*v[256:263]*/, v[216:223], v[144:151]
	v_wmma_f32_16x16x32_bf16 v[152:159], v[16:23] /*v[272:279]*/, v[216:223], v[152:159]
	v_wmma_f32_16x16x32_bf16 v[168:175], v[48:55] /*v[304:311]*/, v[216:223], v[168:175]
	v_wmma_f32_16x16x32_bf16 v[176:183], v[64:71] /*v[320:327]*/, v[216:223], v[176:183]
	v_wmma_f32_16x16x32_bf16 v[184:191], v[80:87] /*v[336:343]*/, v[216:223], v[184:191]
	v_wmma_f32_16x16x32_bf16 v[56:63], v[80:87] /*v[336:343]*/, v[208:215], v[56:63]
	v_wmma_f32_16x16x32_bf16 v[40:47], v[64:71] /*v[320:327]*/, v[208:215], v[40:47]
	v_wmma_f32_16x16x32_bf16 v[32:39], v[48:55] /*v[304:311]*/, v[208:215], v[32:39]
	v_wmma_f32_16x16x32_bf16 v[24:31], v[16:23] /*v[272:279]*/, v[208:215], v[24:31]
	v_wmma_f32_16x16x32_bf16 v[16:23], v[0:7] /*v[256:263]*/, v[208:215], v[16:23]
	s_set_vgpr_msb 0x100
	v_wmma_f32_16x16x32_bf16 v[0:7], v[224:231], v[208:215], v[0:7]
...
.LBB0_14:
	...
	v_nop
	s_set_vgpr_msb 0x4404
	v_subrev_nc_u32_e32 v208, s29, v125 /*v381*/
	s_wait_alu depctr_vm_vsrc(6)
	v_subrev_nc_u32_e32 v209, s29, v126 /*v382*/
	v_subrev_nc_u32_e32 v210, s29, v127 /*v383*/
	v_subrev_nc_u32_e32 v211, s29, v128 /*v384*/
	v_subrev_nc_u32_e32 v212, s29, v129 /*v385*/
	v_subrev_nc_u32_e32 v213, s29, v130 /*v386*/
	s_set_vgpr_msb 0x401
	v_dual_add_nc_u32 v208, v65 /*v321*/, v208 :: v_dual_add_nc_u32 v209, v65 /*v321*/, v209
	s_set_vgpr_msb 0x104
	v_subrev_nc_u32_e32 v214, s29, v131 /*v387*/
	v_subrev_nc_u32_e32 v215, s29, v132 /*v388*/
	s_set_vgpr_msb 0x401
	v_dual_add_nc_u32 v210, v65 /*v321*/, v210 :: v_dual_add_nc_u32 v211, v65 /*v321*/, v211
	s_set_vgpr_msb 0x104
	v_subrev_nc_u32_e32 v216, s29, v133 /*v389*/
	v_subrev_nc_u32_e32 v217, s29, v134 /*v390*/
	v_add_nc_u32_e32 v212, v212, v65 /*v321*/
	v_subrev_nc_u32_e32 v218, s29, v156 /*v412*/
	v_subrev_nc_u32_e32 v201, s29, v143 /*v399*/
	s_wait_alu depctr_va_vdst(0)
	s_set_vgpr_msb 0x440
	ds_load_b128 v[8:11] /*v[264:267]*/, v208
	ds_load_b128 v[12:15] /*v[268:271]*/, v209
	ds_load_b128 v[24:27] /*v[280:283]*/, v210
	ds_load_b128 v[28:31] /*v[284:287]*/, v211
	ds_load_b128 v[56:59] /*v[312:315]*/, v212
	s_wait_alu depctr_vm_vsrc(4)
	s_set_vgpr_msb 0x4001
	v_add_nc_u32_e32 v208, v65 /*v321*/, v213
	s_set_vgpr_msb 0x104
	v_subrev_nc_u32_e32 v194, s29, v149 /*v405*/
	v_subrev_nc_u32_e32 v219, s29, v157 /*v413*/
	s_wait_alu depctr_vm_vsrc(2)
	s_set_vgpr_msb 0x401
	v_dual_add_nc_u32 v209, v65 /*v321*/, v214 :: v_dual_add_nc_u32 v210, v65 /*v321*/, v215
	s_set_vgpr_msb 0x104
	v_subrev_nc_u32_e32 v195, s29, v150 /*v406*/
	v_subrev_nc_u32_e32 v222, s29, v158 /*v414*/
	v_subrev_nc_u32_e32 v196, s29, v151 /*v407*/
	v_subrev_nc_u32_e32 v223, s29, v159 /*v415*/
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x401
	v_dual_add_nc_u32 v211, v65 /*v321*/, v216 :: v_dual_add_nc_u32 v212, v65 /*v321*/, v217
	s_set_vgpr_msb 0x104
	v_subrev_nc_u32_e32 v197, s29, v152 /*v408*/
	v_subrev_nc_u32_e32 v224, s29, v160 /*v416*/
	s_set_vgpr_msb 0x444
	...
	v_subrev_nc_u32_e32 v225, s29, v161 /*v417*/
	s_set_vgpr_msb 0x401
	v_dual_add_nc_u32 v201, v65 /*v321*/, v201 :: v_dual_add_nc_u32 v194, v65 /*v321*/, v194
	s_wait_alu depctr_va_vdst(14)
	s_set_vgpr_msb 0x140
	ds_load_b128 v[60:63] /*v[316:319]*/, v208
	s_wait_alu depctr_va_vdst(12)
	ds_load_b128 v[72:75] /*v[328:331]*/, v209
	ds_load_b128 v[76:79] /*v[332:335]*/, v210
	s_wait_alu depctr_va_vdst(7)
	ds_load_b128 v[88:91] /*v[344:347]*/, v211
	ds_load_b128 v[92:95] /*v[348:351]*/, v212
	s_wait_alu depctr_vm_vsrc(3)
	s_set_vgpr_msb 0x4001
	v_dual_add_nc_u32 v208, v65 /*v321*/, v218 :: v_dual_add_nc_u32 v209, v65 /*v321*/, v219
	...
	v_subrev_nc_u32_e32 v226, s29, v162 /*v418*/
	s_set_vgpr_msb 0x444
	v_subrev_nc_u32_e32 v2 /*v258*/, s29, v139 /*v395*/
	v_subrev_nc_u32_e32 v54 /*v310*/, s29, v145 /*v401*/
	s_set_vgpr_msb 0x4404
	v_subrev_nc_u32_e32 v200, s29, v155 /*v411*/
	v_subrev_nc_u32_e32 v227, s29, v163 /*v419*/
	s_set_vgpr_msb 0x401
	v_dual_add_nc_u32 v195, v65 /*v321*/, v195 :: v_dual_add_nc_u32 v196, v65 /*v321*/, v196
	s_wait_alu depctr_vm_vsrc(1)
	v_dual_add_nc_u32 v210, v65 /*v321*/, v222 :: v_dual_add_nc_u32 v211, v65 /*v321*/, v223
	s_set_vgpr_msb 0x104
	v_subrev_nc_u32_e32 v220, s29, v135 /*v391*/
	s_set_vgpr_msb 0x444
	...
	v_subrev_nc_u32_e32 v221, s29, v136 /*v392*/
	s_set_vgpr_msb 0x444
	v_subrev_nc_u32_e32 v64 /*v320*/, s29, v147 /*v403*/
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0x4401
	v_dual_add_nc_u32 v197, v65 /*v321*/, v197 :: v_dual_add_nc_u32 v212, v65 /*v321*/, v224
	s_wait_alu depctr_va_vdst(14)
	s_set_vgpr_msb 0x140
	ds_load_b128 v[40:43] /*v[296:299]*/, v201
	ds_load_b128 v[44:47] /*v[300:303]*/, v194
	s_wait_alu depctr_va_vdst(9)
	s_set_vgpr_msb 0x4000
	ds_load_b128 v[248:251], v195
	ds_load_b128 v[252:255], v196
	s_wait_alu depctr_va_vdst(0)
	ds_load_b128 v[232:235], v197
	s_wait_alu depctr_vm_vsrc(3)
	s_set_vgpr_msb 1
	v_add_nc_u32_e32 v194, v65 /*v321*/, v198
	s_set_vgpr_msb 0x140
	ds_load_b128 v[32:35] /*v[288:291]*/, v208
	ds_load_b128 v[36:39] /*v[292:295]*/, v209
	s_set_vgpr_msb 0x4000
	ds_load_b128 v[240:243], v210
	ds_load_b128 v[244:247], v211
	ds_load_b128 v[216:219], v212
	s_wait_alu depctr_vm_vsrc(4)
	s_set_vgpr_msb 1
	v_add_nc_u32_e32 v208, v65 /*v321*/, v225
	...
	v_dual_add_nc_u32 v195, v65 /*v321*/, v199 :: v_dual_add_nc_u32 v196, v65 /*v321*/, v200
	s_wait_alu depctr_vm_vsrc(0)
	v_dual_add_nc_u32 v209, v65 /*v321*/, v226 :: v_dual_add_nc_u32 v212, v65 /*v321*/, v227
	s_set_vgpr_msb 0x145
	...
	s_set_vgpr_msb 0x4501
	v_dual_add_nc_u32 v200, v65 /*v321*/, v193 :: v_dual_add_nc_u32 v204, v65 /*v321*/, v192
	v_dual_add_nc_u32 v224, v65 /*v321*/, v220 :: v_dual_add_nc_u32 v228, v65 /*v321*/, v221
	s_set_vgpr_msb 0x145
	...
	ds_load_b128 v[200:203], v200
	ds_load_b128 v[204:207], v204
	ds_load_b128 v[220:223], v208
	s_wait_alu depctr_vm_vsrc(0)
	ds_load_b128 v[208:211], v209
