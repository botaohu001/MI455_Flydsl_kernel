...
.LBB0_14:
	...
	s_set_vgpr_msb 0x100
	v_wmma_f32_16x16x32_bf16 v[8:15], v[228:235], v[204:211], v[8:15]
	...
	s_max_i32 s4, s2, 0
	v_wmma_f32_16x16x32_bf16 v[56:63], v[244:251], v[204:211], v[56:63]
	...
	s_set_vgpr_msb 1
	s_barrier_wait -1
	v_wmma_f32_16x16x32_bf16 v[64:71], v[2:9] /*v[258:265]*/, v[204:211], v[64:71]
	s_wait_alu depctr_va_vdst(0)
	s_set_vgpr_msb 0x100
	...
	s_lshl_b32 s6, s9, 6
	s_set_vgpr_msb 1
	v_wmma_f32_16x16x32_bf16 v[104:111], v[2:9] /*v[258:265]*/, v[196:203], v[104:111]
	s_set_vgpr_msb 0x100
	...
	v_wmma_f32_16x16x32_bf16 v[80:87], v[244:251], v[196:203], v[80:87]
	...
	v_wmma_f32_16x16x32_bf16 v[72:79], v[236:243], v[196:203], v[72:79]
	s_wait_alu depctr_vm_vsrc(0)
	...
	v_wmma_f32_16x16x32_bf16 v[48:55], v[228:235], v[196:203], v[48:55]
	s_wait_alu depctr_vm_vsrc(1)
