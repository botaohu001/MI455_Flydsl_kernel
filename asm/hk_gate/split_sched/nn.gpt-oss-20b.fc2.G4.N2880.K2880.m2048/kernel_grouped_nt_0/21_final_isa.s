...
.LBB0_8:
	...
	v_mad_u32 v9 /*v777*/, 0x90, v40 /*v552*/, v3 /*v515*/
	s_set_vgpr_msb 0xe8cc
	s_delay_alu instid0(VALU_DEP_1)
	v_dual_add_nc_u32 v8 /*v776*/, 32, v9 /*v777*/ :: v_dual_add_nc_u32 v5 /*v773*/, 64, v9 /*v777*/
	v_add_nc_u32_e32 v6 /*v774*/, 0x60, v9 /*v777*/
	s_set_vgpr_msb 0xcc00
	s_branch .LBB0_11
.LBB0_10:
	s_mov_b32 s8, -1
.LBB0_11:
	...
	v_dual_add_nc_u32 v16 /*v784*/, 0, v3 /*v515*/ :: v_dual_add_nc_u32 v9 /*v777*/, v15 /*v783*/, v3 /*v515*/
	s_max_i32 s3, s33, 0
...
.LBB0_13:
	s_set_vgpr_msb 10
	s_wait_dscnt 0x14
	v_wmma_f32_16x16x32_bf16 v[0:7], v[104:111] /*v[616:623]*/, v[248:255] /*v[760:767]*/, v[0:7]
	v_wmma_f32_16x16x32_bf16 v[8:15], v[128:135] /*v[640:647]*/, v[248:255] /*v[760:767]*/, v[8:15]
	...
	v_wmma_f32_16x16x32_bf16 v[56:63], v[128:135] /*v[640:647]*/, v[232:239] /*v[744:751]*/, v[56:63]
	v_wmma_f32_16x16x32_bf16 v[24:31], v[104:111] /*v[616:623]*/, v[232:239] /*v[744:751]*/, v[24:31]
	v_wmma_f32_16x16x32_bf16 v[176:183], v[104:111] /*v[616:623]*/, v[224:231] /*v[736:743]*/, v[176:183]
	v_wmma_f32_16x16x32_bf16 v[184:191], v[128:135] /*v[640:647]*/, v[224:231] /*v[736:743]*/, v[184:191]
	...
	v_wmma_f32_16x16x32_bf16 v[240:247], v[128:135] /*v[640:647]*/, v[200:207] /*v[712:719]*/, v[240:247]
	v_wmma_f32_16x16x32_bf16 v[232:239], v[104:111] /*v[616:623]*/, v[200:207] /*v[712:719]*/, v[232:239]
	s_set_vgpr_msb 0xa5a
	v_wmma_f32_16x16x32_bf16 v[64:71] /*v[320:327]*/, v[104:111] /*v[616:623]*/, v[184:191] /*v[696:703]*/, v[64:71] /*v[320:327]*/
	v_wmma_f32_16x16x32_bf16 v[72:79] /*v[328:335]*/, v[128:135] /*v[640:647]*/, v[184:191] /*v[696:703]*/, v[72:79] /*v[328:335]*/
	...
	v_wmma_f32_16x16x32_bf16 v[120:127] /*v[376:383]*/, v[128:135] /*v[640:647]*/, v[152:159] /*v[664:671]*/, v[120:127] /*v[376:383]*/
	v_wmma_f32_16x16x32_bf16 v[88:95] /*v[344:351]*/, v[104:111] /*v[616:623]*/, v[152:159] /*v[664:671]*/, v[88:95] /*v[344:351]*/
	v_wmma_f32_16x16x32_bf16 v[176:183] /*v[432:439]*/, v[104:111] /*v[616:623]*/, v[120:127] /*v[632:639]*/, v[176:183] /*v[432:439]*/
	...
	v_wmma_f32_16x16x32_bf16 v[96:103], v[128:135] /*v[640:647]*/, v[88:95] /*v[600:607]*/, v[96:103]
	v_wmma_f32_16x16x32_bf16 v[88:95], v[104:111] /*v[616:623]*/, v[88:95] /*v[600:607]*/, v[88:95]
	s_wait_dscnt 0x0
	s_wait_tensorcnt 0x1
	s_barrier_signal -1
	...
	v_wmma_f32_16x16x32_bf16 v[72:79], v[136:143] /*v[648:655]*/, v[168:175] /*v[680:687]*/, v[72:79]
	v_wmma_f32_16x16x32_bf16 v[224:231], v[136:143] /*v[648:655]*/, v[144:151] /*v[656:663]*/, v[224:231]
	...
	v_wmma_f32_16x16x32_bf16 v[176:183], v[8:15] /*v[520:527]*/, v[96:103] /*v[608:615]*/, v[176:183]
	v_wmma_f32_16x16x32_bf16 v[184:191], v[24:31] /*v[536:543]*/, v[96:103] /*v[608:615]*/, v[184:191]
	v_wmma_f32_16x16x32_bf16 v[200:207], v[40:47] /*v[552:559]*/, v[96:103] /*v[608:615]*/, v[200:207]
	v_wmma_f32_16x16x32_bf16 v[208:215], v[48:55] /*v[560:567]*/, v[96:103] /*v[608:615]*/, v[208:215]
	v_wmma_f32_16x16x32_bf16 v[216:223], v[64:71] /*v[576:583]*/, v[96:103] /*v[608:615]*/, v[216:223]
	s_set_vgpr_msb 0xa5a
	v_wmma_f32_16x16x32_bf16 v[56:63] /*v[312:319]*/, v[80:87] /*v[592:599]*/, v[96:103] /*v[608:615]*/, v[56:63] /*v[312:319]*/
	v_wmma_f32_16x16x32_bf16 v[48:55] /*v[304:311]*/, v[112:119] /*v[624:631]*/, v[96:103] /*v[608:615]*/, v[48:55] /*v[304:311]*/
	v_wmma_f32_16x16x32_bf16 v[40:47] /*v[296:303]*/, v[136:143] /*v[648:655]*/, v[96:103] /*v[608:615]*/, v[40:47] /*v[296:303]*/
	v_wmma_f32_16x16x32_bf16 v[32:39] /*v[288:295]*/, v[136:143] /*v[648:655]*/, v[72:79] /*v[584:591]*/, v[32:39] /*v[288:295]*/
	...
	v_wmma_f32_16x16x32_bf16 v[136:143] /*v[392:399]*/, v[136:143] /*v[648:655]*/, v[56:63] /*v[568:575]*/, v[136:143] /*v[392:399]*/
	v_wmma_f32_16x16x32_bf16 v[224:231] /*v[480:487]*/, v[136:143] /*v[648:655]*/, v[32:39] /*v[544:551]*/, v[224:231] /*v[480:487]*/
	...
	v_wmma_f32_16x16x32_bf16 v[248:255] /*v[504:511]*/, v[136:143] /*v[648:655]*/, v[16:23] /*v[528:535]*/, v[248:255] /*v[504:511]*/
	s_set_vgpr_msb 0x5a0a
	v_wmma_f32_16x16x32_bf16 v[160:167], v[136:143] /*v[648:655]*/, v[0:7] /*v[512:519]*/, v[160:167]
...
.LBB0_14:
	...
	ds_load_tr16_b128 v[104:107] /*v[616:619]*/, v58 /*v570*/
	s_wait_alu depctr_va_vdst(3)
	ds_load_tr16_b128 v[108:111] /*v[620:623]*/, v4 /*v516*/
	s_wait_alu depctr_va_vdst(1)
	ds_load_tr16_b128 v[128:131] /*v[640:643]*/, v5 /*v517*/
	...
	s_wait_alu depctr_va_vdst(7)
	ds_load_tr16_b128 v[132:135] /*v[644:647]*/, v0 /*v512*/
	s_wait_alu depctr_va_vdst(5)
	...
	ds_load_b128 v[96:99] /*v[608:611]*/, v4 /*v516*/
	...
	v_dual_add_nc_u32 v136 /*v648*/, v113 /*v625*/, v85 /*v597*/ :: v_dual_add_nc_u32 v140 /*v652*/, v113 /*v625*/, v84 /*v596*/
...
.LBB0_19:
	...
	v_dual_add_nc_u32 v35 /*v547*/, s0, v7 /*v775*/ :: v_dual_add_nc_u32 v37 /*v549*/, s0, v9 /*v777*/
	s_set_vgpr_msb 0x8c88
	v_add_nc_u32_e32 v36 /*v548*/, s0, v34 /*v546*/
	s_set_vgpr_msb 0x888e
	v_add_nc_u32_e32 v38 /*v550*/, s0, v8 /*v776*/
	s_wait_alu depctr_va_vdst(0)
	...
	v_dual_add_nc_u32 v2 /*v514*/, s1, v7 /*v775*/ :: v_dual_add_nc_u32 v3 /*v515*/, s1, v9 /*v777*/
	s_wait_alu depctr_vm_vsrc(6)
	s_set_vgpr_msb 0x8c88
	v_dual_add_nc_u32 v36 /*v548*/, s1, v34 /*v546*/ :: v_dual_add_nc_u32 v0 /*v512*/, s1, v0 /*v512*/
	s_set_vgpr_msb 0x888c
	v_add_nc_u32_e32 v4 /*v516*/, s1, v8 /*v776*/
	s_set_vgpr_msb 0x8c8a
	...
	s_wait_alu depctr_vm_vsrc(6)
	s_set_vgpr_msb 0x8a8e
	v_add_nc_u32_e32 v0 /*v512*/, s1, v5 /*v773*/
	...
	s_wait_alu depctr_vm_vsrc(6)
	v_add_nc_u32_e32 v4 /*v516*/, s1, v6 /*v774*/
	...
	ds_load_tr16_b128 v[16:19] /*v[528:531]*/, v36 /*v548*/ offset:17440
	ds_load_tr16_b128 v[230:233] /*v[742:745]*/, v36 /*v548*/ offset:26112
	ds_load_tr16_b128 v[20:23] /*v[532:535]*/, v36 /*v548*/ offset:26144
	...
	ds_load_tr16_b128 v[24:27] /*v[536:539]*/, v36 /*v548*/ offset:17568
	ds_load_tr16_b128 v[246:249] /*v[758:761]*/, v36 /*v548*/ offset:26240
	ds_load_tr16_b128 v[28:31] /*v[540:543]*/, v36 /*v548*/ offset:26272
	s_set_vgpr_msb 0x8ec2
	...
	v_wmma_f32_16x16x32_bf16 v[8:15], v[16:23] /*v[528:535]*/, v[170:177] /*v[682:689]*/, v[8:15]
	v_nop
	v_nop
	...
	s_set_vgpr_msb 10
	v_wmma_f32_16x16x32_bf16 v[48:55], v[24:31] /*v[536:543]*/, v[170:177] /*v[682:689]*/, v[48:55]
	s_set_vgpr_msb 0xa00
	...
	s_set_vgpr_msb 10
	v_wmma_f32_16x16x32_bf16 v[168:175], v[24:31] /*v[536:543]*/, v[178:185] /*v[690:697]*/, v[168:175]
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0xa00
	...
	s_set_vgpr_msb 10
	v_wmma_f32_16x16x32_bf16 v[56:63], v[16:23] /*v[528:535]*/, v[178:185] /*v[690:697]*/, v[56:63]
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 0xa00
	...
	s_set_vgpr_msb 10
	v_wmma_f32_16x16x32_bf16 v[184:191], v[16:23] /*v[528:535]*/, v[186:193] /*v[698:705]*/, v[184:191]
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0xa00
	...
	s_set_vgpr_msb 0x5a
	v_wmma_f32_16x16x32_bf16 v[56:63] /*v[312:319]*/, v[24:31] /*v[536:543]*/, v[186:193] /*v[698:705]*/, v[56:63] /*v[312:319]*/
	s_wait_alu depctr_vm_vsrc(1)
	...
	s_set_vgpr_msb 0x55a
	v_wmma_f32_16x16x32_bf16 v[16:23] /*v[272:279]*/, v[24:31] /*v[536:543]*/, v[194:201] /*v[706:713]*/, v[16:23] /*v[272:279]*/
	s_set_vgpr_msb 0x5a05
	...
	s_set_vgpr_msb 10
	v_wmma_f32_16x16x32_bf16 v[240:247], v[16:23] /*v[528:535]*/, v[194:201] /*v[706:713]*/, v[240:247]
	s_set_vgpr_msb 0xa00
	...
	s_set_vgpr_msb 0x5a
	v_wmma_f32_16x16x32_bf16 v[72:79] /*v[328:335]*/, v[16:23] /*v[528:535]*/, v[202:209] /*v[714:721]*/, v[72:79] /*v[328:335]*/
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x5a05
	...
	s_set_vgpr_msb 0x5a
	v_wmma_f32_16x16x32_bf16 v[112:119] /*v[368:375]*/, v[24:31] /*v[536:543]*/, v[202:209] /*v[714:721]*/, v[112:119] /*v[368:375]*/
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x5a05
	...
	s_set_vgpr_msb 0x55a
	v_wmma_f32_16x16x32_bf16 v[168:175] /*v[424:431]*/, v[24:31] /*v[536:543]*/, v[210:217] /*v[722:729]*/, v[168:175] /*v[424:431]*/
	s_set_vgpr_msb 0x5a05
	...
	s_set_vgpr_msb 0x55a
	v_wmma_f32_16x16x32_bf16 v[120:127] /*v[376:383]*/, v[16:23] /*v[528:535]*/, v[210:217] /*v[722:729]*/, v[120:127] /*v[376:383]*/
	s_set_vgpr_msb 0x5a05
	...
	s_set_vgpr_msb 0x5a
	v_wmma_f32_16x16x32_bf16 v[184:191] /*v[440:447]*/, v[16:23] /*v[528:535]*/, v[218:225] /*v[730:737]*/, v[184:191] /*v[440:447]*/
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x5a05
	...
	s_set_vgpr_msb 0x5a
	v_wmma_f32_16x16x32_bf16 v[232:239] /*v[488:495]*/, v[24:31] /*v[536:543]*/, v[218:225] /*v[730:737]*/, v[232:239] /*v[488:495]*/
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x5a05
	...
	s_set_vgpr_msb 10
	v_wmma_f32_16x16x32_bf16 v[96:103], v[16:23] /*v[528:535]*/, v[0:7] /*v[512:519]*/, v[96:103]
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0xa00
	...
	s_set_vgpr_msb 10
	v_wmma_f32_16x16x32_bf16 v[136:143], v[24:31] /*v[536:543]*/, v[0:7] /*v[512:519]*/, v[136:143]
	s_set_vgpr_msb 0xa00
