...
.LBB0_4:
	...
	v_and_or_b32 v65 /*v321*/, 0xffffffc0, s38, v69 /*v325*/
...
.LBB0_9:
	...
	ds_load_b128 v[40:43] /*v[296:299]*/, v78 /*v334*/
	ds_load_b128 v[44:47] /*v[300:303]*/, v78 /*v334*/ offset:32
	ds_load_b128 v[24:27] /*v[280:283]*/, v78 /*v334*/ offset:4352
	ds_load_b128 v[28:31] /*v[284:287]*/, v78 /*v334*/ offset:4384
	ds_load_b128 v[8:11] /*v[264:267]*/, v78 /*v334*/ offset:8704
	ds_load_b128 v[12:15] /*v[268:271]*/, v78 /*v334*/ offset:8736
	ds_load_b128 v[0:3] /*v[256:259]*/, v78 /*v334*/ offset:13056
	ds_load_b128 v[4:7] /*v[260:263]*/, v78 /*v334*/ offset:13088
	ds_load_b128 v[16:19] /*v[272:275]*/, v77 /*v333*/
	ds_load_b128 v[20:23] /*v[276:279]*/, v77 /*v333*/ offset:32
	ds_load_b128 v[32:35] /*v[288:291]*/, v77 /*v333*/ offset:4352
	ds_load_b128 v[36:39] /*v[292:295]*/, v77 /*v333*/ offset:4384
	ds_load_b128 v[48:51] /*v[304:307]*/, v77 /*v333*/ offset:8704
	ds_load_b128 v[52:55] /*v[308:311]*/, v77 /*v333*/ offset:8736
	ds_load_b128 v[56:59] /*v[312:315]*/, v77 /*v333*/ offset:13056
	ds_load_b128 v[60:63] /*v[316:319]*/, v77 /*v333*/ offset:13088
...
.LBB0_14:
	...
	s_set_vgpr_msb 0x440
	v_add3_u32 v63 /*v319*/, v133, v158, s0
	...
	s_wait_alu depctr_va_vdst(0)
	ds_load_b128 v[132:135], v128
	ds_load_b128 v[136:139], v128 offset:32
	s_wait_alu depctr_vm_vsrc(0)
	s_set_vgpr_msb 5
	v_add_nc_u32_e32 v128, s0, v66 /*v322*/
	ds_load_b128 v[140:143], v62 /*v318*/ offset:4544
	ds_load_b128 v[144:147], v62 /*v318*/ offset:4576
	...
	ds_load_b128 v[168:171], v128 offset:32
	s_set_vgpr_msb 1
	...
	v_wmma_f32_16x16x32_bf16 v[24:31], v[254:261], v[198:205], v[24:31]
	v_wmma_f32_16x16x32_bf16 v[56:63], v[254:261], v[206:213], v[56:63]
	...
	v_wmma_f32_16x16x32_bf16 v[88:95], v[254:261], v[214:221], v[88:95]
	v_wmma_f32_16x16x32_bf16 v[120:127], v[254:261], v[222:229], v[120:127]
	...
	s_set_vgpr_msb 5
	v_wmma_f32_16x16x32_bf16 v[0:7], v[38:45] /*v[294:301]*/, v[6:13] /*v[262:269]*/, v[0:7]
	v_wmma_f32_16x16x32_bf16 v[8:15], v[46:53] /*v[302:309]*/, v[6:13] /*v[262:269]*/, v[8:15]
	v_wmma_f32_16x16x32_bf16 v[16:23], v[54:61] /*v[310:317]*/, v[6:13] /*v[262:269]*/, v[16:23]
	v_wmma_f32_16x16x32_bf16 v[24:31], v[68:75] /*v[324:331]*/, v[6:13] /*v[262:269]*/, v[24:31]
	v_wmma_f32_16x16x32_bf16 v[56:63], v[68:75] /*v[324:331]*/, v[14:21] /*v[270:277]*/, v[56:63]
	v_wmma_f32_16x16x32_bf16 v[48:55], v[54:61] /*v[310:317]*/, v[14:21] /*v[270:277]*/, v[48:55]
	v_wmma_f32_16x16x32_bf16 v[40:47], v[46:53] /*v[302:309]*/, v[14:21] /*v[270:277]*/, v[40:47]
	v_wmma_f32_16x16x32_bf16 v[32:39], v[38:45] /*v[294:301]*/, v[14:21] /*v[270:277]*/, v[32:39]
	v_wmma_f32_16x16x32_bf16 v[64:71], v[38:45] /*v[294:301]*/, v[22:29] /*v[278:285]*/, v[64:71]
	v_wmma_f32_16x16x32_bf16 v[72:79], v[46:53] /*v[302:309]*/, v[22:29] /*v[278:285]*/, v[72:79]
	v_wmma_f32_16x16x32_bf16 v[80:87], v[54:61] /*v[310:317]*/, v[22:29] /*v[278:285]*/, v[80:87]
	v_wmma_f32_16x16x32_bf16 v[88:95], v[68:75] /*v[324:331]*/, v[22:29] /*v[278:285]*/, v[88:95]
	v_wmma_f32_16x16x32_bf16 v[120:127], v[68:75] /*v[324:331]*/, v[30:37] /*v[286:293]*/, v[120:127]
	v_wmma_f32_16x16x32_bf16 v[112:119], v[54:61] /*v[310:317]*/, v[30:37] /*v[286:293]*/, v[112:119]
	v_wmma_f32_16x16x32_bf16 v[104:111], v[46:53] /*v[302:309]*/, v[30:37] /*v[286:293]*/, v[104:111]
	v_wmma_f32_16x16x32_bf16 v[96:103], v[38:45] /*v[294:301]*/, v[30:37] /*v[286:293]*/, v[96:103]
	s_set_vgpr_msb 0x500
