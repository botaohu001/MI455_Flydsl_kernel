...
.LBB0_13:
	s_set_vgpr_msb 4
	s_wait_dscnt 0xf
	v_wmma_f32_16x16x32_bf16 v[0:7], v[208:215], v[24:31] /*v[280:287]*/, v[0:7]
	v_wmma_f32_16x16x32_bf16 v[8:15], v[248:255], v[24:31] /*v[280:287]*/, v[8:15]
	s_set_vgpr_msb 0x405
	v_wmma_f32_16x16x32_bf16 v[16:23], v[8:15] /*v[264:271]*/, v[24:31] /*v[280:287]*/, v[16:23]
	v_wmma_f32_16x16x32_bf16 v[24:31], v[32:39] /*v[288:295]*/, v[24:31] /*v[280:287]*/, v[24:31]
	v_wmma_f32_16x16x32_bf16 v[32:39], v[64:71] /*v[320:327]*/, v[24:31] /*v[280:287]*/, v[32:39]
	v_wmma_f32_16x16x32_bf16 v[40:47], v[72:79] /*v[328:335]*/, v[24:31] /*v[280:287]*/, v[40:47]
	...
	s_set_vgpr_msb 4
	s_wait_dscnt 0xa
	v_wmma_f32_16x16x32_bf16 v[0:7], v[232:239], v[48:55] /*v[304:311]*/, v[0:7]
	s_set_vgpr_msb 0x405
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[8:15], v[16:23] /*v[272:279]*/, v[48:55] /*v[304:311]*/, v[8:15]
	...
	v_wmma_f32_16x16x32_bf16 v[56:63], v[16:23] /*v[272:279]*/, v[0:7] /*v[256:263]*/, v[56:63]
	s_set_vgpr_msb 0x504
	v_wmma_f32_16x16x32_bf16 v[48:55], v[232:239], v[0:7] /*v[256:263]*/, v[48:55]
	s_set_vgpr_msb 0x400
	v_wmma_f32_16x16x32_bf16 v[96:103], v[232:239], v[224:231], v[96:103]
	s_set_vgpr_msb 1
	v_wmma_f32_16x16x32_bf16 v[104:111], v[16:23] /*v[272:279]*/, v[224:231], v[104:111]
	v_wmma_f32_16x16x32_bf16 v[112:119], v[40:47] /*v[296:303]*/, v[224:231], v[112:119]
	v_wmma_f32_16x16x32_bf16 v[120:127], v[56:63] /*v[312:319]*/, v[224:231], v[120:127]
	v_wmma_f32_16x16x32_bf16 v[128:135], v[80:87] /*v[336:343]*/, v[224:231], v[128:135]
	v_wmma_f32_16x16x32_bf16 v[136:143], v[88:95] /*v[344:351]*/, v[224:231], v[136:143]
	...
	s_set_vgpr_msb 0x100
	v_wmma_f32_16x16x32_bf16 v[144:151], v[232:239], v[216:223], v[144:151]
...
.LBB0_14:
	...
	v_subrev_nc_u32_e32 v226, s29, v156 /*v412*/
	...
	v_subrev_nc_u32_e32 v227, s29, v157 /*v413*/
	...
	s_set_vgpr_msb 0x444
	v_subrev_nc_u32_e32 v16 /*v272*/, s29, v137 /*v393*/
	v_subrev_nc_u32_e32 v60 /*v316*/, s29, v142 /*v398*/
	s_set_vgpr_msb 0x4404
	v_subrev_nc_u32_e32 v198, s29, v153 /*v409*/
	v_subrev_nc_u32_e32 v233, s29, v161 /*v417*/
	s_set_vgpr_msb 0x401
	...
	s_set_vgpr_msb 0x4001
	v_dual_add_nc_u32 v216, v81 /*v337*/, v226 :: v_dual_add_nc_u32 v217, v81 /*v337*/, v227
	s_set_vgpr_msb 0x144
	v_subrev_nc_u32_e32 v17 /*v273*/, s29, v138 /*v394*/
	v_subrev_nc_u32_e32 v20 /*v276*/, s29, v141 /*v397*/
	v_subrev_nc_u32_e32 v61 /*v317*/, s29, v144 /*v400*/
	s_set_vgpr_msb 0x4404
	v_subrev_nc_u32_e32 v199, s29, v154 /*v410*/
	v_subrev_nc_u32_e32 v234, s29, v162 /*v418*/
	s_set_vgpr_msb 0x444
	v_subrev_nc_u32_e32 v18 /*v274*/, s29, v139 /*v395*/
	v_subrev_nc_u32_e32 v62 /*v318*/, s29, v145 /*v401*/
	s_set_vgpr_msb 0x4404
	v_subrev_nc_u32_e32 v204, s29, v155 /*v411*/
	v_subrev_nc_u32_e32 v235, s29, v163 /*v419*/
	s_set_vgpr_msb 0x401
	...
	s_set_vgpr_msb 0x104
	v_subrev_nc_u32_e32 v228, s29, v135 /*v391*/
	s_set_vgpr_msb 0x444
	v_subrev_nc_u32_e32 v19 /*v275*/, s29, v140 /*v396*/
	v_subrev_nc_u32_e32 v63 /*v319*/, s29, v146 /*v402*/
	s_set_vgpr_msb 0x4404
	v_subrev_nc_u32_e32 v193, s29, v148 /*v404*/
	v_subrev_nc_u32_e32 v192, s29, v123 /*v379*/
	v_subrev_nc_u32_e32 v229, s29, v136 /*v392*/
	s_set_vgpr_msb 0x444
	...
	s_wait_alu depctr_va_vdst(14)
	s_set_vgpr_msb 0x140
	ds_load_b128 v[24:27] /*v[280:283]*/, v200
	ds_load_b128 v[28:31] /*v[284:287]*/, v194
	...
	s_wait_alu depctr_vm_vsrc(4)
	s_set_vgpr_msb 1
	v_add_nc_u32_e32 v216, v81 /*v337*/, v233
	s_set_vgpr_msb 0x145
	v_dual_add_nc_u32 v16 /*v272*/, v81 /*v337*/, v16 /*v272*/ :: v_dual_add_nc_u32 v21 /*v277*/, v81 /*v337*/, v17 /*v273*/
	...
	s_wait_alu depctr_vm_vsrc(0)
	v_dual_add_nc_u32 v217, v81 /*v337*/, v234 :: v_dual_add_nc_u32 v220, v81 /*v337*/, v235
	s_set_vgpr_msb 0x145
	v_dual_add_nc_u32 v56 /*v312*/, v81 /*v337*/, v20 /*v276*/ :: v_dual_add_nc_u32 v82 /*v338*/, v81 /*v337*/, v61 /*v317*/
	v_dual_add_nc_u32 v40 /*v296*/, v81 /*v337*/, v18 /*v274*/ :: v_dual_add_nc_u32 v44 /*v300*/, v81 /*v337*/, v19 /*v275*/
	s_set_vgpr_msb 0x4501
	v_dual_add_nc_u32 v208, v81 /*v337*/, v193 :: v_dual_add_nc_u32 v212, v81 /*v337*/, v192
	v_dual_add_nc_u32 v232, v81 /*v337*/, v228 :: v_dual_add_nc_u32 v236, v81 /*v337*/, v229
	s_set_vgpr_msb 0x145
...
.LBB0_19:
	...
	s_wait_alu depctr_vm_vsrc(5)
	v_dual_mov_b32 v195, s4 :: v_dual_mov_b32 v3, s0
