...
.LBB0_11:
	v_mov_b32_e32 v7, 0
	s_set_vgpr_msb 0xc0
	v_and_b32_e32 v11 /*v779*/, 8, v0
	s_set_vgpr_msb 0xc0c8
	v_mad_u32_u24 v10 /*v778*/, 0x220, v5 /*v517*/, s3
...
.LBB0_13:
	...
	v_wmma_f32_16x16x32_bf16 v[88:95], v[168:175] /*v[680:687]*/, v[232:239] /*v[744:751]*/, v[88:95]
	...
	v_wmma_f32_16x16x32_bf16 v[200:207], v[168:175] /*v[680:687]*/, v[200:207] /*v[712:719]*/, v[200:207]
	...
	v_wmma_f32_16x16x32_bf16 v[0:7] /*v[256:263]*/, v[96:103] /*v[608:615]*/, v[184:191] /*v[696:703]*/, v[0:7] /*v[256:263]*/
	v_wmma_f32_16x16x32_bf16 v[8:15] /*v[264:271]*/, v[112:119] /*v[624:631]*/, v[184:191] /*v[696:703]*/, v[8:15] /*v[264:271]*/
	v_wmma_f32_16x16x32_bf16 v[16:23] /*v[272:279]*/, v[152:159] /*v[664:671]*/, v[184:191] /*v[696:703]*/, v[16:23] /*v[272:279]*/
	...
	v_wmma_f32_16x16x32_bf16 v[40:47] /*v[296:303]*/, v[208:215] /*v[720:727]*/, v[184:191] /*v[696:703]*/, v[40:47] /*v[296:303]*/
	v_wmma_f32_16x16x32_bf16 v[48:55] /*v[304:311]*/, v[216:223] /*v[728:735]*/, v[184:191] /*v[696:703]*/, v[48:55] /*v[304:311]*/
	v_wmma_f32_16x16x32_bf16 v[56:63] /*v[312:319]*/, v[240:247] /*v[752:759]*/, v[184:191] /*v[696:703]*/, v[56:63] /*v[312:319]*/
	...
	v_wmma_f32_16x16x32_bf16 v[88:95] /*v[344:351]*/, v[168:175] /*v[680:687]*/, v[144:151] /*v[656:663]*/, v[88:95] /*v[344:351]*/
	...
	v_wmma_f32_16x16x32_bf16 v[152:159] /*v[408:415]*/, v[168:175] /*v[680:687]*/, v[104:111] /*v[616:623]*/, v[152:159] /*v[408:415]*/
	...
	v_wmma_f32_16x16x32_bf16 v[216:223] /*v[472:479]*/, v[168:175] /*v[680:687]*/, v[88:95] /*v[600:607]*/, v[216:223] /*v[472:479]*/
	...
	s_wait_dscnt 0xe
	v_wmma_f32_16x16x32_bf16 v[0:7], v[8:15] /*v[520:527]*/, v[176:183] /*v[688:695]*/, v[0:7]
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x32_bf16 v[8:15], v[24:31] /*v[536:543]*/, v[176:183] /*v[688:695]*/, v[8:15]
	v_wmma_f32_16x16x32_bf16 v[16:23], v[40:47] /*v[552:559]*/, v[176:183] /*v[688:695]*/, v[16:23]
	v_wmma_f32_16x16x32_bf16 v[24:31], v[48:55] /*v[560:567]*/, v[176:183] /*v[688:695]*/, v[24:31]
	v_wmma_f32_16x16x32_bf16 v[32:39], v[64:71] /*v[576:583]*/, v[176:183] /*v[688:695]*/, v[32:39]
	v_wmma_f32_16x16x32_bf16 v[40:47], v[80:87] /*v[592:599]*/, v[176:183] /*v[688:695]*/, v[40:47]
	v_wmma_f32_16x16x32_bf16 v[48:55], v[128:135] /*v[640:647]*/, v[176:183] /*v[688:695]*/, v[48:55]
	v_wmma_f32_16x16x32_bf16 v[56:63], v[136:143] /*v[648:655]*/, v[176:183] /*v[688:695]*/, v[56:63]
	v_wmma_f32_16x16x32_bf16 v[120:127], v[136:143] /*v[648:655]*/, v[160:167] /*v[672:679]*/, v[120:127]
	v_wmma_f32_16x16x32_bf16 v[112:119], v[128:135] /*v[640:647]*/, v[160:167] /*v[672:679]*/, v[112:119]
	v_wmma_f32_16x16x32_bf16 v[104:111], v[80:87] /*v[592:599]*/, v[160:167] /*v[672:679]*/, v[104:111]
	v_wmma_f32_16x16x32_bf16 v[96:103], v[64:71] /*v[576:583]*/, v[160:167] /*v[672:679]*/, v[96:103]
	v_wmma_f32_16x16x32_bf16 v[88:95], v[48:55] /*v[560:567]*/, v[160:167] /*v[672:679]*/, v[88:95]
	v_wmma_f32_16x16x32_bf16 v[80:87], v[40:47] /*v[552:559]*/, v[160:167] /*v[672:679]*/, v[80:87]
	v_wmma_f32_16x16x32_bf16 v[72:79], v[24:31] /*v[536:543]*/, v[160:167] /*v[672:679]*/, v[72:79]
	v_wmma_f32_16x16x32_bf16 v[64:71], v[8:15] /*v[520:527]*/, v[160:167] /*v[672:679]*/, v[64:71]
...
.LBB0_14:
	...
	v_subrev_nc_u32_e32 v58 /*v570*/, s29, v10 /*v778*/
	...
	ds_load_tr16_b128 v[168:171] /*v[680:683]*/, v5 /*v517*/
	ds_load_tr16_b128 v[172:175] /*v[684:687]*/, v6 /*v518*/
	s_wait_alu depctr_vm_vsrc(3)
	s_set_vgpr_msb 0x8e8a
	...
	s_wait_alu depctr_va_vdst(2)
	ds_load_b128 v[176:179] /*v[688:691]*/, v5 /*v517*/
	ds_load_b128 v[180:183] /*v[692:695]*/, v6 /*v518*/
	s_wait_alu depctr_vm_vsrc(3)
	s_set_vgpr_msb 0x8e8a
	...
	ds_load_b128 v[160:163] /*v[672:675]*/, v0 /*v512*/
	ds_load_b128 v[164:167] /*v[676:679]*/, v3 /*v515*/
...
.LBB0_19:
	s_set_vgpr_msb 0x8c
	v_or3_b32 v3 /*v515*/, s24, v11 /*v779*/, s2
	...
	s_mov_b32 s7, 0
	v_lshl_add_u32 v3 /*v515*/, v3 /*v515*/, 1, v10 /*v778*/
	s_mul_i32 s0, s0, 0x11800
	s_delay_alu instid0(SALU_CYCLE_1)
	s_add_co_i32 s0, s0, 0
	s_set_vgpr_msb 0xba8c
	v_dual_add_nc_u32 v184 /*v696*/, s0, v7 /*v775*/ :: v_dual_add_nc_u32 v60 /*v572*/, s0, v8 /*v776*/
	s_wait_alu depctr_vm_vsrc(2)
	s_set_vgpr_msb 0x8c88
	v_dual_add_nc_u32 v252 /*v764*/, s0, v3 /*v515*/ :: v_dual_add_nc_u32 v132 /*v644*/, s0, v1 /*v513*/
	s_set_vgpr_msb 0x888c
	v_dual_add_nc_u32 v64 /*v576*/, s0, v9 /*v777*/ :: v_dual_add_nc_u32 v192 /*v704*/, s0, v6 /*v774*/
	s_wait_alu depctr_vm_vsrc(1)
	s_set_vgpr_msb 0x8c88
	v_add_nc_u32_e32 v136 /*v648*/, s0, v2 /*v514*/
	s_set_vgpr_msb 0x888e
	v_add_nc_u32_e32 v188 /*v700*/, s0, v5 /*v773*/
	s_barrier_wait -1
	s_wait_alu depctr_va_vdst(0)
	...
	s_wait_alu depctr_vm_vsrc(6)
	s_set_vgpr_msb 0x888c
	v_dual_add_nc_u32 v184 /*v696*/, s1, v7 /*v775*/ :: v_dual_add_nc_u32 v60 /*v572*/, s1, v8 /*v776*/
	v_add_nc_u32_e32 v64 /*v576*/, s1, v9 /*v777*/
	s_set_vgpr_msb 0x8c8a
	s_barrier_wait -1
	v_add_nc_u32_e32 v2 /*v514*/, s1, v2 /*v514*/
	s_wait_alu depctr_va_vdst(0)
	...
	ds_load_b128 v[36:39] /*v[548:551]*/, v184 /*v696*/ offset:9216
	ds_load_b128 v[40:43] /*v[552:555]*/, v184 /*v696*/ offset:9248
	v_add_nc_u32_e32 v2 /*v514*/, s1, v6 /*v774*/
	ds_load_b128 v[44:47] /*v[556:559]*/, v184 /*v696*/ offset:11520
	ds_load_b128 v[48:51] /*v[560:563]*/, v184 /*v696*/ offset:11552
	ds_load_b128 v[52:55] /*v[564:567]*/, v184 /*v696*/ offset:13824
	ds_load_b128 v[56:59] /*v[568:571]*/, v184 /*v696*/ offset:13856
